...
@section('content')
    <h3 class="text-danger">Customer Upload</h3>
        ...
        <div class="card-body">
            <form method="post" action="" id="pricelistupload" enctype="multipart/form-data">
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('uploads/CUSTOMERS TEMPLATE.csv') }}" class="btn btn-outline-primary w-100"
                            download>
    ...
    <div class="card shadow-lg rounded-4 border-0">
        <div class="container mt-4">
            <div class="table-responsive">
                <table id="CusUpTbl" class="table table-bordered table-striped w-100">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#CusUpTbl').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "getCustomeruploadData",
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'pricelist', name: 'pricelist' },

                    {

                        data: 'customerupload_id',
                        name: 'actions',
                        orderable: false,
                        searchable: false,
            ...
            $('#CusUpTbl thead').on('keyup change', '.column-search', function () {
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            if (status == "ERROR") {
                window.location.replace('customeruploadedit/' + id);
            }
            else {
        ...
        $(document).on('click', '.view-btn', function () {
            ...
            window.location.replace('customeruploadview/' + id);
        ...
        $.ajax({
            ...
            type: "GET",
            data: {
                table: "s_customerupload_t:batch_name:batch_name",
                parent: condition1,
        ...
        $('.verifyed').click(function () {
            ...
            var url = "{{URL::to('getCustomervalidate')}}";
