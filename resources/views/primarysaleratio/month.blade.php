...
<div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
  <form action="{{ url('primarysaleratio') }}" method="get" id="searchForm">
        ...
        <thead>
            ...
            <?php elseif (request('division') != ''): ?>
                <?php endif; ?>
                    ...
                    <th colspan="1" class="align text-white bg-danger" >last 6 months upto {{ $mon_yr}}</th>
                    <th colspan="1" class="align text-white bg-danger" >MONTH WISE</th>
                    <th colspan="2" class="align text-white bg-danger" >Sum of Asseesable Value</th>
                ...
                <tr>
                    <th class="align text-white bg-secondary text-center" >Month</th>
                     <th class="align text-white bg-secondary text-center" >Sales</th>
                      <th class="align text-white bg-secondary text-center" >Sample</th>
...
<tfoot>
    ...
    <?php } ?>
         ...
         <!-- summary chart -->
            ...
            <h5 class="chart_tittle">Month Wise Sample Ratio - {{ $mon_yr}}</h5>
                    <canvas id="monthChart" style="max-height:460px"></canvas>
			</div>
            </div>
            <div class='col-md-6' >
				<div class="card shadow-lg rounded-4 border-0 p-3 mb-4">
                <h5 class="chart_tittle">Zone Wise Sample Ratio - {{ $mon_yr}}</h5>
...
// zone
const primchartData = {!! $zone_sumchart !!};
var variant = primchartData.map(item => item.zone);
