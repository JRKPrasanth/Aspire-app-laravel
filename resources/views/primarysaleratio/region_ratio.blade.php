...
@section('content')
  <h3 class="text-danger">Region Wise Ratio</h3>
  ...
  <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
    <form action="{{ url('primarysaleregratio') }}" method="get" id="searchForm">
      ...
      <table id="Table1" class="table table-bordered table-striped table-hover w-100">
        <thead>
          <tr>
            ...
            <th colspan="35" class="align text-white bg-danger text-left">ALL INDIA - % SAMPLE to SALES RATIO - REGION
              WISE</th>
          </tr>
          <tr>
            <th colspan="1" class="text-white bg-warning text-center">Sum of Asseesable Value</th>
            <?php $Zones = []; ?>
            <?php foreach ($zone_wise as $value) {
    $zone_type = $value->region;
  ...
  foreach ($products as $product): ?>
        ...
        return $value->region == $zone && $value->sfg_product_name == $product;
      });
