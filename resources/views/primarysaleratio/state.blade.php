...
<div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
  <form action="{{ url('primarysaleratiostate') }}" method="get" id="searchForm">
    ...
    <div class="table-responsive" style="overflow-x: auto;">
        ...
        <thead>
            <tr>
                ...
                <th  colspan="4" class="align  text-white bg-danger text-center" >ALL INDIA - % SAMPLE TO SALES RATIO - State</th>
                 </tr>
                 <tr>

                    <th colspan="1" class="align text-white text-center bg-secondary" >last 6 months upto {{ $mon_yr}}</th>
                    <th colspan="1" class="align text-white text-center bg-secondary" >MONTH WISE</th>
                    <th colspan="2" class="align text-white text-center bg-secondary" >Sum of Asseesable Value</th>


                </tr>
                <tr>
                    <th class="align text-center bg-warning" >State</th>
                     <th class="align text-center bg-warning" >Sales</th>
                      <th class="align text-center bg-warning" >Sample</th>
                       <th class="align text-center bg-warning" >Ratio</th>
                </tr>
            </thead>
   <tbody>
    <?php
...
<!-- Add the total row for all products -->
    ...
    <tr class='sticky-foot'>
        <td colllspan="1" >Grand Total</td>
    ...
    <?php } ?>
     ...
     <!-- END -->
         ...
         <div class="card shadow-lg rounded-4 border-0 p-3 mb-4">
          <h5 class="chart_tittle">State Wise Sample Ratio - {{ $mon_yr}}</h5>
...
const productData = {!! $state_sumchart !!};
...
const monthData = {!! $state_sumchart !!};
var variant = monthData.map(item => item.state);
