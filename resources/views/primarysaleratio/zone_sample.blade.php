...
@section('content')
<h3 class="text-danger">Zone Wise Sample</h3>
...
<div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
  <form action="{{ url('primaryzonesample') }}" method="get" id="searchForm">
    ...
    <div class="table-responsive" style="overflow-x: auto;">
        ...
        <thead>
            ...
            <?php endif; ?>
                ...
                <th colspan="6" class="align text-white bg-danger text-center" >ZONE WISE SAMPLED</th>
        ...
        $(document).ready(function() {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'sale_to_smple_ratio_zone',
                    },
                    {
                        extend: 'pdfHtml5',
                        filename: 'sale_to_smple_ratio_zone',
