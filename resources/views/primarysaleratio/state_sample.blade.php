...
<div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
  <form action="{{ url('primarystatesample') }}" method="get" id="searchForm">
...
<div class="card shadow-lg rounded-4 border-0 p-4">
    <div class="table-responsive" style="overflow-x: auto;">
        ...
        <thead>
            ...
            <?php endif; ?>
                <th colspan="4" class="align text-white bg-danger text-center">last 6 months upto  {{ $mon_yr}}</th>
                <th colspan="20" class="align text-white bg-danger text-left" >STATE WISE SAMPLED</th>
