...
@section('content')
<h3 class="text-danger">Month Wise Sample</h3>
...
<div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
  <form action="{{ url('primarymonthsample') }}" method="get" id="searchForm">
...
<div class="card shadow-lg rounded-4 border-0 p-4">
    <div class="table-responsive" style="overflow-x: auto;">
        ...
        <thead>
            ...
            <?php endif; ?>
                <th class="align text-white bg-danger text-center" >last 6 months upto  {{ $mon_yr}}</th>
                <th colspan="7" class="align text-white bg-danger text-center" >MONTH WISE SAMPLED</th>
...
<tbody>
    ...
    foreach ($month_sample as $value) {
        ...
        $monthlySales[$value->division][$value->sfg_product_name][$value->month_y] = $value->sample;
    }

    // Loop through unique  HQ Name, Zone, Region, State combinations
