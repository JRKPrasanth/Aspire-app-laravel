...
@section('content')
  ...
  <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
    <form action="{{ url('primarysaleratiopro') }}" method="get" id="searchForm">
      ...
      <table id="Table1" class="table table-bordered table-striped table-hover w-100">
        <thead>
          <tr>
            ...
            <th colspan="4" class="align text-white bg-danger text-center">PRODUCT WISE RATIO %</th>
          </tr>
          <tr>
    ...
    $totalSample += $value->sample;
      ?>
          <tr>
            ...
            <td class="sticky-col">{{ $value->sfg_product_name }}</td>
    ...
    $(document).ready(function () {
      $('#Table1').DataTable({
        ...
        buttons: [
          {
            extend: 'excelHtml5',
            filename: 'sample_to_sale_product',
          },
          {
            extend: 'pdfHtml5',
            filename: 'sample_to_sale_product',
