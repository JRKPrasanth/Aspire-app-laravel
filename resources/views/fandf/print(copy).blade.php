...
$pdf->Line(109, $y+.3, 109, 273.5, $style);
...
$pdf->Line(65, $y+.3, 65, 273.5 ,$style);

$pdf->Line(80, $y+.3, 80, 273.5, $style);

$pdf->Line(95, $y+7, 95, 273.5, $style);
...
$pdf->SetFont('','','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(35,2, "April'21",0,'L');
...
$pdf->Line(165, $y-84.2, 165, $y, $style);

 
$pdf->Line(180, $y-84.2, 180, $y, $style);
