...
$( document ).ready(function() {
	 var colModel=[
	    ...
	    { dataIndx: "sales_order_date", align: "center",title: "Req Date" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Category" , filter: { crules: [{condition: "begin" }] }},
        ...
        { dataIndx: "sales_order_no",align: "center",title: "Batch Size" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Units Planed" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "RM Avilability Date" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "PM Avilability Date" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "customer_name", align: "center",title: "Remarks", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "delivery_date", align: "center",title: "QC Date", filter: { crules: [{condition: "begin" }] } },
        { dataIndx: "delivery_date", align: "center",title: "Schedule Date", filter: { crules: [{condition: "begin" }] } },
        { dataIndx: "delivery_date", align: "center",title: "Actual Date", filter: { crules: [{condition: "begin" }] } },
        { dataIndx: "delivery_date", align: "center",title: "No of Days Filling To Packing Deviation", filter: { crules: [{condition: "begin" }] } },
        { dataIndx: "delivery_date", align: "center",title: "Packing Planned Date", filter: { crules: [{condition: "begin" }] } },
        { dataIndx: "delivery_date", align: "center",title: "Actual packing Date", filter: { crules: [{condition: "begin" }] } },
        { dataIndx: "concatenated_product",align: "center",title: "Operation BDR", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "concatenated_product",align: "center",title: "Total BDR", filter: { crules: [{condition: "begin" }] }}
