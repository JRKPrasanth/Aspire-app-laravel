...
$( document ).ready(function() {
     var colModel=[
        ...
        { dataIndx: "sales_order_no",align: "center",title: "Machine ID" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Machine Name Of Jrk" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Date Of Maintanance" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Tot Usg Hrs" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Tot Idle Hrs" , filter: { crules: [{condition: "begin" }] }},
