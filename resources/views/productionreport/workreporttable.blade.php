...
$( document ).ready(function() {
     var colModel=[
        ...
        { dataIndx: "sales_order_no",align: "center",title: "Man Power" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum Of Act" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum Of Act Qty" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum Of In Days" , filter: { crules: [{condition: "begin" }] }}
        ];
  //define dataModel
        var dataModel = {
            location: "remote",            
