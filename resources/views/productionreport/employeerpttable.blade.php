...
$( document ).ready(function() {
     var colModel=[
        ...
        { dataIndx: "sales_order_date", align: "center",title: "Planned Date" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Type" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Product" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Work Activity" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Unit Pack" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Emp Name" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum-Ind" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum-Ind Exp" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum-Ind Act" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum-Ind Dev Hrs" , filter: { crules: [{condition: "begin" }] }}
        ];
  //define dataModel
        var dataModel = {
            location: "remote",            
