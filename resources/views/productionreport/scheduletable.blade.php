...
$( document ).ready(function() {
     var colModel=[
        { dataIndx: "productionplan_hdr_id", align: "center",title: "Id" ,hidden:true},
        { dataIndx: "plan_date", align: "center",title: "Planned Date" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "job_status",align: "center",title: "Work Type" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "concatenated_product",align: "center",title: "Product" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "pack_name",align: "center",title: "Unit Pack" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "batch_no",align: "center",title: "Batch No" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "process_name",align: "center",title: "Work Activity" , filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "production_qty",align: "center",title: "Sum" , filter: { crules: [{condition: "begin" }] }}
