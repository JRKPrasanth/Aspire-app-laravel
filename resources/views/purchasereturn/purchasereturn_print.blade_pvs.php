...
$this->Image($image_file, 15	, 10, 35, 15, 'JPG', '', 'T', false, 250, '', false, false, 0, false, false, false);
// Set font
...
$header=array("Format No:","Revision: ","Date: ".$return_date);
$x=235;$y=235;
...
$header=array('No.','QUANTITY','','','DESCRIPTION','','','','Amount(Rs.)','','P.');
$x=235;$y=235;
foreach($header as $key=>$value)
{
    $pdf->SetXY($x-220,78);
...
{  
	...
	$pdf->SetFont('','','9');
	$pdf->SetTextColor('0','0','0');
	$pdf->MultiCell(65,10, $value->product_id ,0,'L');
	$oldY=$pdf->getY();
