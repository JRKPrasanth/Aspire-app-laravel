        ...
        { data: 'first_name', name: 'tb_users.first_name' },
        {
          ...
          let buttons = '';
            if (window.toolbarButtons?.some(btn => btn.attr.id === 'edit-btn')) {
				buttons +=`<button  class="btn btn-sm btn-primary me-1 edit-btn" data-id="${data}"><i class="bi bi-pencil"></i></button>`;
			}
			    return buttons;
          }
...
{
    var url="{{ url('createdashboardaccess') }}/0";
    ...
    const url = "{{ url('createdashboardaccess') }}/" + id;
