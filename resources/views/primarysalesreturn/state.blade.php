...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('primarysalesreturnstate') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <th colspan="4" class="align text-white bg-danger text-center">ALL INDIA - % SALES RETURN TO SALES
                            RATIO - STATE</th>
                    </tr>
                    <tr style="background:#ffd2bc">

                        <th colspan="1" class="align text-white bg-secondary text-center">up to {{ $mon_yr}}</th>
                        <th colspan="1" class="align text-white bg-secondary text-center">STATE WISE</th>
                    ...
                    <tr>
                        ...
                        <th class="align bg-warning">Sales</th>
                        <th class="align bg-warning">Sales Return</th>
                        <th class="align bg-warning">Ratio</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <h5 class="chart_tittle">State Wise Sales Return Ratio% upto - {{ $mon_yr}}</h5>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'state_wise_sales_return',
                    },
                    {
                        extend: 'pdfHtml5',
                        filename: 'state_wise_sales_return',
        ...
        const primchartData = {!! $state_sumchart !!};

        var variant = primchartData.map(item => item.state);
        ...
        new Chart("monthChart", {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "Sales Return Ratio % Region",
