...
@section('content')
  <h3 class="text-danger">Month Wise Return</h3>
  ...
  <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
    <form action="{{ url('primarysalesreturnpermonth') }}" method="get" id="searchForm">
      ...
      <table id="Table1" class="table table-bordered table-striped table-hover w-100">
        <thead>
          <tr>
            ...
            <th colspan="8" class="align text-white bg-danger text-center">MONTH WISE SALES RETURN LAST 6 MONTHS UPTO -
              {{ $mon_yr }}</th>
    ...
    $(document).ready(function () {
      $('#Table1').DataTable({
        ...
        buttons: [
          {
            extend: 'excelHtml5',
            filename: 'month_wise_product_unit_return',
          },
          {
            extend: 'pdfHtml5',
            filename: 'month_wise_product_unit_return',
