...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('primarysalesreturnregion') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="align  bg-warning text-center">Sales</th>
                        <th class="align  bg-warning text-center">Sales Return</th>
                        <th class="align  bg-warning text-center">Ratio</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <h5 class="chart_tittle">Region Wise Sales Return Ratio% - upto {{ $mon_yr}}</h5>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'region_wise_sales_return',
                    },
                    {
                        extend: 'pdfHtml5',
                        filename: 'region_wise_sales_return',
        ...
        var variant = primchartData.map(item => item.region);
