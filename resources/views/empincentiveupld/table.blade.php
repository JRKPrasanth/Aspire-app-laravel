...
@section('content')
    <h3 class="text-danger">Employee Incentive Upload</h3>
        ...
        <div class="card-body">
            <form method="post" action="" id="empinsupload" enctype="multipart/form-data">
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('uploads/Employee_Incentive_Template.csv') }}"  class="btn btn-outline-primary w-100"
                            download>
    ...
    <div class="card shadow-lg rounded-4 border-0">
        <div class="container mt-4">
            <div class="table-responsive">
                <table id="IncentiveTbl" class="table table-bordered table-striped w-100">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#IncentiveTbl').DataTable({
                processing: true,
                serverSide: false,
                scrollX: true,
                scrollY: "50vh",
                ...
                columns: [
                    ...
                    { data: 'tds_applicable', name: 'tds_applicable' },
                    { data: 'tds_rate', name: 'tds_rate' },
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            if (status == "ERROR") {
                window.location.replace('empinsuploadedit/' + id);
            }
            else {
        ...
        $.ajax({
            ...
            type: "GET",
            data: {
                table: "f_empinsupload_t:batchname:batchname",
                parent: condition1,
