...
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,': '.$payment_number[$pk],0,1,'L');
...
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,': '.$bank_name[$pk],0,1,'L');
...
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,': '.$account_number[$pk],0,1,'L');
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(300,0,$supplier_name[$pk],0,'L');

$ss=$pdf->getY();

if($favouring_name[$pk]!="")
{
$pdf->SetXY(55,$ss);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(300,0,$favouring_name[$pk],0,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(280,0,$supplier_address[$pk],0,'L'); 
}else
{
  $pdf->SetXY(55,$ss);
$pdf->SetFont('','','9');
...
//for($j=0;$j<29;$j++) {
//dd($linedata[$pk]);
foreach($linedata[$pk] as $key=>$value) { 
  if($oldY==0) $y =285;
  else $y = $oldY+2; 
...
$poinv+=$value['invoice_grand_total'];
...
if($payment_source[$pk]!="ADVANCE")
{
    if($advance_amount[$pk]!=0){
...
$pdf->SetXY(340,$oldY+1);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(90,10,'(-) '.number_format($advance_amount[$pk],2),0,'R');
  }
}
...
//if($advance_amount!=0){
$pdf->SetXY(340,$oldY+10);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(90,10,number_format(($poinv-$advance_amount[$pk]-$tdstotal[$pk]),2),0,'R');
//}
$pdf->SetXY(465,$oldY+10);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
//$pdf->MultiCell(90,10,number_format(($grand_total-$tdstota),2),0,'R');
$pdf->MultiCell(90,10,number_format(($grand_total[$pk]),2),0,'R');

if($debit_amount[$pk]!="")
{
    
$pdf->SetXY(210,$oldY+20);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,'Debit Amount (Rs): ',0,1,'L');
//$oldY=$pdf->getY();

$pdf->SetXY(375,$oldY+20);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(90,10,'(-) '.number_format(($debit_amount[$pk]),2),0,'R');
//$oldY=$pdf->getY();
}  
...
$pdf->SetXY(73,$oldY+60);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(80,0,'Payment Type',0,1,'L');

$pdf->SetXY(73,$oldY+82);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(80,10,$payment_name[$pk],0,'C');

$pdf->SetXY(145,$oldY+60);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(110,0,'UTR Number',0,1,'C');
//$pdf->MultiCell(130,10,'Payment Ref/Cheque No',0,'C');

$pdf->SetXY(140,$oldY+82);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(110,10,$payment_reference[$pk],0,'C');

$pdf->SetXY(237,$oldY+60);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(100,0,'Cheque No',0,1,'C');

$pdf->SetXY(237,$oldY+82);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,10,$cheque_no[$pk],0,'C');

$pdf->SetXY(325,$oldY+60);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,'Cheque Date',0,1,'L');

$pdf->SetXY(325,$oldY+82);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(85,10,$cheque_date[$pk],0,'C');

$pdf->SetXY(410,$oldY+60);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,'Payment Date',0,1,'L');

$pdf->SetXY(410,$oldY+82);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(85,10,$payment_date[$pk],0,'C');
...
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(90,10,number_format($payment_amount[$pk],2),0,'R');

$pdf->SetXY(410,$oldY+130);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
...
$pdf->Line(145, $oldY+60, 145, $oldY+155, $style);
$pdf->Line(245, $oldY+60, 245, $oldY+155, $style);
$pdf->Line(320, $oldY+60, 320, $oldY+155, $style);
$pdf->Line(400, $oldY+60, 400, $oldY+155, $style);
$pdf->Line(485, $oldY+60, 485, $oldY+155, $style);
$pdf->Line(560, $oldY+40, 560, $oldY+155, $style);

$pdf->SetXY(37,$oldY+162);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(500,0,$remarks[$pk],0,'L');
...
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,$supplier_name[$pk],0,1,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0,$favouring_name[$pk],0,1,'L');
...
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(120,10,$cheque_no[$pk],0,'C');
