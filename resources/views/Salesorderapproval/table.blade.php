...
<a id="edit"><button type="button" class="btn sec">Approve Sales Order</button></a>
...
url: "salesorderapproval",
datatype: "json",
mtype: "GET",
colNames: ["","Order Number","Order Date","Order Type","ordertype Status","Customer Name","Remarks"],
colModel: [
...
{ name: "customer_id", label: "Customer", width: 250,stype:'select', editoptions:{value:opt} },
...
$('#gs_soorderapprovalgrid_customer_id').select2();
...
if(status!="Approved" && status !="Rejected" ){
		...
		window.location.replace('salesorderapprovalview/' +saleshdrid+'/'+ordertype);
}else{
