                            ...
                            <form action="{{ url('targetuploadsave')}}" method="post" enctype="multipart/form-data">
                                ...
                                {{ csrf_field()}}
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <a href="{{url('/Uploads/sr_upload.csv')}}"  class="lst btn download" download>Download Template</a>
                                          </div>  
                                       <!--  </div> -->
...
<?php if($pageMethod=="awdtargets"){ ?>
	...
	mtype: "GET",
        colModel: [
            ...
            { name: "stockist_name", label: "SR Name", width: 200,editable:true, editrules:{date:true}},
