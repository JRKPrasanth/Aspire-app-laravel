                            ...
                            <form action="{{ url('targetuploadsave')}}" method="post" enctype="multipart/form-data">
                                ...
                                {{ csrf_field()}}
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <a href="{{url('/Uploads/targets_upload.csv')}}"  class="lst btn download" download>Download Template</a>
                                          </div>  
                                       <!--  </div> -->
...
<?php if($pageMethod=="awdtargets"){ ?>
	...
	mtype: "GET",
        colModel: [
            ...
            { name: "stockist_name", label: "Stockist Name", width: 200,editable:true, editrules:{date:true}},
            { name: "state_name", label: "State", width:80, editable:true, editrules:{date:true}},
            { name: "city_name", label: "City", width:250, editable:true, editrules:{date:true}},
...
/**** file choose start*****/
		...
		var newUrl = "{{URL::to('distributortargets')}}";
