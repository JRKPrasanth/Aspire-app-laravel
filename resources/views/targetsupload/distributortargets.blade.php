...
@section('content')
    <h3 class="text-danger">Target Upload</h3>
        ...
        <div class="card-body">
            <form method="post" action="" id="pricelistupload" enctype="multipart/form-data">
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('Uploads/targets_upload.csv') }}" class="btn btn-outline-primary w-100" download>
    ...
    <div class="card shadow-lg rounded-4 border-0">
        <div class="container mt-4">
            <div class="table-responsive">
                <table id="TargetTbl" class="table table-bordered table-striped w-100">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#TargetTbl').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "gettargetuploaddata",
                    data: function (d) {
                        d.batchname = $(".batchnumber").val(); // 
                    }
                },
            ...
            $('#TargetTbl thead').on('keyup change', '.column-search', function () {
        ...
        $.ajax({
            ...
            type: "GET",
            data: {
                table: "target_upload_tbl:batch_name:batch_name",
                parent: condition1,
        ...
        $('.loaded').click(function () {
            ...
            var newUrl = refineUrl();//fetch new url
            var url = "{{URL::to('getdistributorvalidate')}}";
