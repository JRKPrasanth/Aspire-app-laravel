...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-12 col-md-3">
                <a href="purchaseproductexceptionrpt" class="btn btn-primary w-100">Price Trend Exception</a>
            </div>
            <div class="col-12 col-md-3">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <form action="{{ url('purchaseproductexceptionrpt') }}" method="get" id="searchForm">
            <div class="row g-4">

                <!-- Supplier Name -->
                <div class="col-md-4">
                    <label for="product_group" class="form-label fw-semibold">Product Group</label>
                    <select name="product_group" id="product_group" class="form-select select2" required>
                        {!! $pro_group !!}
                    </select>
                </div>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-white" style="background:#c54444">{{ request('start_date')}} To
                            {{ request('end_date')}}</th>
                        <?php endif; ?>
                        <th colspan="6" class="text-center text-white" style="background:#47647c;">Price Trend Exception
                        </th>
                    </tr>
                    ...
                    <tr style="background:#c32323 !important;">
                        ...
                        <th class="text-center bg-danger text-white">Current Price</th>
                        <th class="text-center bg-danger text-white">Previous Price</th>
                        <th class="text-center bg-danger text-white">%</th>
                        <th class="text-center bg-danger text-white">Impact</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">{{$value->old_price}}</td>
                        <td style="text-align: center;">{{$value->ratio}}</td>
                        <td style="text-align: center;">{{$value->impact}}</td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
