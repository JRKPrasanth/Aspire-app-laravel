...
<h2 class="heads">Tour Plan Approval</h2>
...
$("#grid1").jqGrid({
url: "getapprovaltourplanData",
datatype: "json",
mtype: "GET",
	 colModel: [
	{ name: "id", label: "id",hidden: true },	
    { name: "first_name",label: "Name"},
	{ name: "total", label: "Type",editable:true,search:false,editrules:{date:true}}
...
jQuery("#grid1").jqGrid('filterToolbar',{stringResult: true,searchOnEnter : false});
 ...
 $(document).on('click',".exportpdf",function() {
      $("#grid1").jqGrid('exportToPdf', {
          ...
          includeFooter: true,
          fileName : "Tourplan Approval.pdf",
   ...
   $(document).on('click',".exportexcel",function() {
        $("#grid1").jqGrid("exportToExcel",{
            ...
            includeGroupHeader : true,
            includeFooter: true,
            fileName : "Tourplan Approval.xlsx"
...
showcolumn('grid1');
	...
	$("#edit").click(function()
	{
		...
		var cellValue = jQuery("#grid1").jqGrid ('getCell', gr, 'tour_id');
	...
	$('#view').click(function(){ 
	  	...
	  	var cellValue = $("#grid1").jqGrid ('getCell', gr, 'tour_id');
