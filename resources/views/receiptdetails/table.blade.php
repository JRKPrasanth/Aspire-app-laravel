...
@section('content')
  <h3 class="text-danger">Receipt Details Report</h3>
        ...
        <table id="ReportTbl" class="table table-striped table-bordered">
          <thead>
            <tr class="table-warning">
              <th class="freeze">Receipt Number</th>
              <th>Receipt Date</th>
              <th>Receipt Type</th>
              <th>Customer Name</th>
            ...
            <tr class="table-danger">
              <th class="freeze"><input type="text" class="column-search" placeholder="Search"><span
                  style="display:none;">Receipt Number</span></th>
              <th><input type="text" class="column-search start_date" placeholder="Search"><span
                  style="display:none;">Receipt Date</span></th>
  ...
  <script>
    $(document).ready(function () {
      ...
      var table = $('#ReportTbl').DataTable({
        ...
        serverSide: false,
        ajax: {
          url: "{{ url('getReceiptdetailssData') }}",
          type: "GET",
          data: function (d) {
