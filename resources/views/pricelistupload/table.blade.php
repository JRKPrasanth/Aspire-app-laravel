...
@section('content')
    <h3 class="text-danger">PriceList Upload</h3>
        ...
        <div class="card-body">
            <form method="post" action="" id="pricelistupload" enctype="multipart/form-data">
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('uploads/PRICELIST TEMPLATE.csv') }}" class="btn btn-outline-primary w-100"
                            download>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            if (status == "ERROR") {
                window.location.replace('pricelistuploadedit/' + id);
            }
            else {
        ...
        $.ajax({
            ...
            type: "GET",
            data: {
                table: "i_pricelist_upload_t:batch_name:batch_name",
                parent: condition1,
        ...
        $('#myModal1').on('shown.bs.modal', function () {
            $('.index').click(function () {
                ...
                if (tmp2 != "") {
                    ...
                    $.ajax({
                        url: "{{URL::to('pricelistdataupload')}}",
                        data: form_data,
                        type: 'POST',
        ...
        $('.verifyed').click(function () {
            ...
            var url = "{{URL::to('getPricevalidate')}}";
