...
@section('content')
    <h3 class="text-danger">Product Group</h3>
    ...
    if (isset($data[$pageMethod]['save'])) { ?>
                ...
                <input type="hidden" name="edit_id" value="{{ $row->product_group_id }}" id="edit_id" />
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-7">
                                <input type="text" id="group_name" name="group_name" class="form-control group_name"
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3 align-items-center none">
                            <label for="created_by" class="col-md-5 col-form-label fw-semibold">Created By</label>
                            <div class="col-md-7">
    ...
    <script>
        ...
        $(document).ready(function () {
            var table = $('#InvTbl').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('getProductgroupData') }}",
                columns: [
                  ...
                  <i class="bi bi-pencil"></i>
                            ...
                            if (window.toolbarButtons?.some(btn => btn.attr.id === 'delete')) {
                                buttons += `
                <button class="btn btn-sm btn-danger delete-btn" data-id="${row.product_group_id}">
        ...
        /*deepika purpose:To check Duplicate entry*/
        var dup_chk = true;
        function duplicate_validate() {
            var group_name = $(".group_name").val();
            var edit_id = $("#edit_id").val();
            var url = "{{ URL::to('productgroupcheckname')}}";
            $.ajax({
                cache: false,
                ...
                success: function (response) {
                    ...
                    if (response == 1) {
                        $('.dup_name').html('Group Name:' + group_name + ' Already Exists for this Group');
                        $('.dup_name').show();
                        $(".group_name").val('');
                        dup_chk = false;
        ...
        /*Save Function for Product Group*/
        $(document).on('click', '.saveform', function () {
            ...
            if (form.parsley().isValid()) {
                ...
                var url = "{{ URL::to('productgroupsave')}}";
                if (dup_chk == true) {
        ...
        /*Keyup Function for Product Group*/
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            var url = "{{ url('productgroupedit') }}/" + id;
            ...
            $.get(url, function (data) {
                ...
                if (data == 0) {
                    ...
                    showCustomAlert("You Can't be Edit this Product Group, Already used.", 'warning');
                }
        ...
        $('#globalConfirmDeleteBtn').on('click', function () {
            if (deleteId) {
                $.ajax({
                    url: "{{ url('productgroupdelete') }}/" + deleteId,
                    type: "GET",
