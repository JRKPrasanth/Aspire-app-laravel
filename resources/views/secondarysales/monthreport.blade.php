...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="row g-3 mb-2">
            <div class="col-12 col-md-2">
                <a href="secondarysalesreport" class="btn btn-primary w-100 text-white">Month Wise</a>
            </div>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('secondarysalesreport') }}" method="get" id="searchForm">
            <div class="row g-3">
                    ...
                    <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <?php endif; ?>
                                <th colspan="5" class="align text-white bg-danger text-center">MONTH WISE SALES upto
                                    {{ $mon_yr }}</th>
                            ...
                            <tr>
                                <th class="align sticky-col text-white bg-success text-center">Month</th>
    ...
    foreach ($all_ind_sal as $value) {
        ...
        $totalSalesStock += $value->sales_stock;
                    ?>
                            <tr>
                                <td class="sticky-col" style="text-align:center;">{{$value->month}}</td>
                ...
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="Table3" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            ...
                            <tr>
                                <th colspan="1" class="align sticky-col text-white bg-success text-center">Month</th>
                                <th class="align text-white bg-success text-center"><span class="text-warning"
                                        style="font-size:1px;">Distributor </span>Primary</th>
                                <th class="align text-white bg-success text-center"><span class="text-warning"
                                        style="font-size:1px;">Distributor </span>Sales</th>
                                <th class="align text-white bg-success text-center"><span class="text-warning"
                ...
                $('#Table4').DataTable({
                  ...
                  order: false,
                    buttons: [
                        {
                            extend: 'excelHtml5',
                            filename: 'STOCK LIQUDATION RATIO',
                            exportOptions: {
                                format: {
                                    header: function (data, columnIdx) {
