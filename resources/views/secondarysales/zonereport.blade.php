...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="row g-3 mb-2">
            ...
            <div class="col-12 col-md-3">
                <a href="zonesalesreport" class="btn btn-primary w-100">Zone and Region Wise</a>
            </div>
            <div class="col-12 col-md-2">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('zonesalesreport') }}" method="get" id="searchForm">
            <div class="row g-3">
    ...
    <!---  zone and Region Wise Sale value -->
                    ...
                    <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <?php endif; ?>
                                <th colspan="5" class="align text-white bg-danger text-center">ZONE WISE SALES upto
                                    {{ $mon_yr }}</th>
                            ...
                            <tr>
                                <th class="align sticky-col text-white bg-success text-center">Zone</th>
    ...
    foreach ($all_ind_sal as $value) {
        ...
        $totalSalesStock += $value->sales_stock;
                    ?>
                            <tr>
                                <td class="sticky-col">{{$value->zone}}</td>
                        ...
                        <tfoot class="table-danger">
                            <tr class="sticky-total fw-bold">
                                <td style="text-align:center;text-align: center;">Grand Total</td>
                ...
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="Table3" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            ...
                            <tr>
                                <th colspan="1" class="align sticky-col text-white bg-success text-center">Zone</th>
                                <th class="align text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Primary</th>
                                <th class="align text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Sales</th>
                    ...
                    <table id="Table5" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="align text-white bg-danger text-center">{{ request('region') }}</th>
                                <?php endif; ?>
                                <th colspan="5" class="align text-white bg-danger text-center">REGION WISE SALES upto
                                    {{ $mon_yr }}</th>
                            ...
                            <tr>
                                <th class="align sticky-col text-white bg-success text-center">Region</th>
                                <th class="align sticky-col text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Primary</th>
                                <th class="align sticky-col text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Sales</th>
                                <th class="align sticky-col text-white bg-success text-center"><span class="text-success"
    ...
    foreach ($region_sale as $value) {
        ...
        ?>
                            <tr>
                                <td class="sticky-col">{{$value->region}}</td>
                                <td class="rupee-value" data-original="{{ $value->primary_dis }}">{{$value->primary_dis}}
                                </td>
                                <td class="rupee-value" data-original="{{ $value->sales_dist }}">{{$value->sales_dist}}</td>
                                <td class="rupee-value" data-original="{{ $value->purchase }}">{{$value->purchase}}</td>
        ...
        <div class="col-md-6">
            <div class="card shadow-lg rounded-4 border-0 p-4">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="Table6" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                <?php if (request('zone') != ''): ?>
                                <th class="align text-white bg-danger text-center">{{ request('zone') }}</th>
                            ...
                            <tr>
                                <th class="align align text-white bg-success text-center sticky-col">Region</th>
                                <th class="align align text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Primary</th>
                                <th class="align align text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Sales</th>
                                <th class="align align text-white bg-success text-center"><span class="text-success"
    ...
    foreach ($region_sale_pre as $value) {
        $totalPrimaryDis += $value->primary_dis;
        $totalSalesDist += $value->sales_dist;
        $totalPurchase += $value->purchase;
        $totalSalesStock += $value->sales_stock;
    ...
    <div class="row">
        <div class="col-md-7">
            <div class="card shadow-lg rounded-4 border-0 p-4">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="Table7" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                <?php if (request('zone') != ''): ?>
                                <th class="align text-white bg-danger text-center">{{ request('zone') }}</th>
                            ...
                            <tr>
                                <th colspan="1" class="align sticky-col text-white bg-success text-center">Region</th>
                                <th class="align text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Primary</th>
                                <th class="align text-white bg-success text-center"><span class="text-success"
                                        style="font-size:1px;">Distributor </span>Sales</th>
                        ...
                        <tbody>
                            <?php foreach ($ratio_val_region as $value) { ?>
                            <tr>
                                <td>{{$value['region']}}</td>
                                <td>{{$value['primary_dis_ratio']}}</td>
                                <td>{{$value['sales_dist_ratio']}}</td>
                        ...
                        <tfoot class="table-danger">
                            <?php foreach ($grand_val_region as $value) { ?>
                            <tr class="fw-bold">
                                <td>Total</td>
                                <td>{{$value['primary_dis_ratio']}}</td>
                                <td>{{$value['sales_dist_ratio']}}</td>
        ...
        <div class="col-md-5">
            <div class="card shadow-lg rounded-4 border-0 p-4">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="Table8" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                <?php if (request('zone') != ''): ?>
                                <th class="align text-white bg-danger text-center">{{ request('zone') }}</th>
        ...
        $(document).ready(function () {
            ...
            $('#Table4').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'STOCK LIQUDATION RATIO ZONE',
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
            ...
            $('#Table5').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'REGION WISE SALES',
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
                                    var header1 = $('#Table5 thead tr:eq(0) th').eq(columnIdx).text();
                                    var header3 = $('#Table5 thead tr:eq(2) th').eq(columnIdx).text();
                ...
                buttons: [
                    {
                        ...
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
                                    var header1 = $('#Table6 thead tr:eq(0) th').eq(columnIdx).text();
                                    var header3 = $('#Table6 thead tr:eq(2) th').eq(columnIdx).text();
            ...
            $('#Table7').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'SALES GROWTH REGION',
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
                                    var header1 = $('#Table7 thead tr:eq(0) th').eq(columnIdx).text();
                                    var header3 = $('#Table7 thead tr:eq(2) th').eq(columnIdx).text();
            ...
            $('#Table8').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'STOCK LIQUDATION RATIO REGION',
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
                                    var header1 = $('#Table8 thead tr:eq(0) th').eq(columnIdx).text();
                                    var header3 = $('#Table8 thead tr:eq(2) th').eq(columnIdx).text();
