...
@section('content')
    ...
    <form id="otherdashboardaccess" data-parsley-validate>
        {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-offset-3 col-md-6">
                        <div class="form-group row">
                            <label for="inputIsValid" class="form-control-label col-md-4"><span class="req">*</span>User
                                Name</label>
                            <div class="col-md-6">
                                <select name='user_id' rows='5' class='select2 form-control user_id'
            ...
            <div class="row mb-4 justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <button type="button" class="btn btn-secondary px-4"
                        onclick="location.href = '{{ url('otherdashboardaccess') }}'">Cancel</button>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.saveform', function () {
            const form = $("#otherdashboardaccess");
            let dup_chk = true;
            ...
            if (form.parsley().isValid() && dup_chk === true) {
                ...
                $.ajax({
                    url: "{{ url('otherdashboardaccesssave') }}",
                    type: "POST",
                    data: formData,
                    success: function (response) {
                        if (response.status === "success") {
                            ...
                            setTimeout(() => {
                                window.location.href = "{{ url('otherdashboardaccess') }}";
                            }, 1500);
                        } else {
