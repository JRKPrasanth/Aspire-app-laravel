...
//Page header
    public function Header() {
       ...
       $this->Image($image_file,  12, 7, 18, 15	, 'JPG', '', 'T', false, 250, '', false, false, 0, false, false, false);
        // Set font
...
/************************************ Footer ******************************/
//dd($order_status_id);
if($order_status_id=='APPROVED' || $order_status_id=='COMPLETED'){
$pdf->SetXY(13,270);
$pdf->SetFont('','','10');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(0,0, "Reviewed & Accepted By ",0,'L');

$pdf->SetXY(20,277);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(0,0, $reviewd_accepted_by,0,'L');
}
$pdf->SetXY(110,270);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
