...
@section('content')
    ...
    <h3 class="text-danger">Product Based Report</h3>
    ...
    <div class="container mt-4">
        <div class="row g-3 mb-3">
            ...
            <div class="col-12 col-md-3">
                <a href="operationprobasereport" class="btn btn-info w-100">Product Based Report</a>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <div class="container-fluid">
            <form action="{{ url('operationprobasereport') }}" method="get" id="searchForm">
        ...
        $(document).ready(function () {
            $('.Empname').click(function () {
                ...
                if (employee) {
                    ...
                    var url = "{{ route('protypepopup') }}" + "?" + params;
        ...
        $(document).ready(function () {
            $('.Machinename').click(function () {
                ...
                if (machine) {
                    ...
                    // Build the full URL for the AJAX request
                    var url = "{{ route('machinepropopup') }}" + "?" + params;
