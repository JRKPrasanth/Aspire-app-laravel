...
@section('content')
    <h3 class="text-danger">Best Of The Month</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('bestofmonthmis') }}" method="get" id="searchForm">
                    ...
                    <table id="Table2" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="align text-white bg-secondary text-center">{{ request('manager') }}</th>
                                <?php endif; ?>
                                <th colspan="2" class="align text-white bg-secondary text-center">All India Top 15 Products
                                    (By
                                    Value) - {{ $mon_yr }}</th>
