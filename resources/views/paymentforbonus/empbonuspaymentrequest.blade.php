...
@section('content')
  <h3 class="text-danger">
    ...
    Employee Bonus - Payment Request Approval
    <?php } else { ?>
    Employee Bonus - Payment Request
  ...
  <?php if ($pageMethod == "empbonuspaymentrequestapproval") { ?>

  <button type='button' class='btn btn-success px-4' id='paymentrequestapprove'>Payment Request Approve</button>

  <?php } else { ?>

  <button type='button' class='btn btn-success px-4' id='paymentrequest'>Payment Request</button>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      var table = $('#AccTbl').DataTable({
        ...
        scrollY: "50vh",
        orderCellsTop: true,
        ajax: "getempbonusRequestforpaymentData?pagemethod=" + pagemethod,
        columns: [
          {
            data: 'id',
            orderable: false,
    ...
    $(document).on('click', '#paymentrequest', function () {
      var selected = [];
      $("#AccTbl tbody input.row-checkbox:checked").each(function () {
      ...
      var url = "{{ URL::to('getempbonuspaymentreq') }}/" + selected.join(",");
    ...
    $(document).on('click', '#paymentrequestapprove', function () {
      var selected = [];
      $("#AccTbl tbody input.row-checkbox:checked").each(function () {
        selected.push($(this).val());
      });
      ...
      var url = "{{ URL::to('getempbonuspaymentreqapprove') }}/" + selected.join(",");
