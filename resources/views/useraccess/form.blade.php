...
@section('content')
  ...
  <h2 class="text-danger">User Access</h2>
    ...
    <div class="card shadow-lg rounded-4 border-0">
      <div class="card-body">
        <div class="row mb-4 justify-content-center">
          <div class="col-md-6">
            <label class="form-label fw-bold"><span class="text-danger fw-bold">*</span> User Name</label>
            <select name='user_id' rows='5' class='select2 user_name' data-show-subtext="true" data-live-search="true"
              required>
              {!! $user_name  !!}
            </select>
        ...
        <div class="row mb-4 justify-content-center">
          <div class="col-md-6 text-center">
            ...
            <button type="button" class="btn btn-secondary px-4"
              onclick="location.href = '{{ url('useraccess') }}'">Cancel</button>
          </div>
        </div>
      </div>
    </div>
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (response.status === "success") {
              ...
              setTimeout(() => {
                window.location.href = "{{ url('useraccess') }}";
              }, 1500);
            } else {
