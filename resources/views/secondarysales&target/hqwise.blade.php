...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('salesandtargethq') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="10" class="align text-white bg-danger text-center">HQ WISE TARGET ACHIVEMENT UPTO -
                            {{ $mon_yr }}</th>
                    ...
                    <tr>
                        ...
                        <th class="align bg-warning"><span class="text-warning" style="font-size:1px;">Purchase
                            </span>{{ $pre_fy_year }}</th>
                        <th class="align bg-warning"><span class="text-warning" style="font-size:1px;">Purchase
                            </span>{{ $cur_fy_year}}</th>
                        <th class="align bg-warning"><span class="text-warning" style="font-size:1px;">Purchase
