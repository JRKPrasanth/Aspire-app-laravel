...
@section('content')
    <h3 class="text-danger">Person Wise Monthly Productivity</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('salesandtargetperson') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="7" class="align text-white bg-danger text-center">Personwise Productivity UPTO -
                            {{ $mon_yr }}</th>
                    ...
                    <tr>
                        ...
                        <th class="align bg-warning"><span class="text-warning" style="font-size:6px;">Sale
                            </span>{{ $pre_fy_year }}</th>
                        <th class="align bg-warning"><span class="text-warning" style="font-size:6px;">Sale
                            </span>{{ $cur_fy_year}}</th>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
            ...
            <table id="Table2" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <th class="align text-white bg-danger text-center">{{ request('state') }}</th>
                        <?php endif; ?>
                        <th colspan="64" class="align text-white bg-danger text-center">Monthly Productivity upto
                            {{ $mon_yr}}</th>
                    </tr>
                    <tr>
                        <th colspan="3" class="align text-white bg-secondary text-center"></th>
        ...
        if (!in_array($zone_type, $Zones)) {
            $Zones[] = $zone_type; ?>
                    ...
                    <tr>
                        <th class="sticky-col bg-warning">State</th>
                        <th class="sticky-coll bg-warning">Currrent Reporting MGR</th>
                        <th class="sticky-colll bg-warning">Field Force Name</th>
