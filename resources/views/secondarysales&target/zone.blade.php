...
@section('content')
    <h3 class="text-danger">Zone Wise</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('salesandtargetzone') }}" method="get" id="searchForm">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    ...
                    <input type="month" name="date_select" id="date_select month" class="form-control" autocomplete="off">
                </div>
                    ...
                    <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <?php endif; ?>
                                <th colspan="6" class="align text-white bg-danger text-center">ZONE WISE TARGET ACHIVEMENT
                                    UPTO {{ $mon_yr }}</th>
                            ...
                            <tr>
                                <th class="align bg-warning">Zone</th>
                    ...
                    <table id="Table2" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="align text-white bg-danger text-center">{{ request('region') }}</th>
                                <?php endif; ?>
                                <th colspan="4" class="align text-white bg-danger text-center">ZONE WISE DISTRIBUTOR SALE
                                    UPTO {{ $mon_yr }}</th>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <h5 class="chart_tittle">Zone Wise Growth and Achievement Chart upto - {!! $mon_yr !!}</h5>
        ...
        $(document).ready(function () {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'ZONE WISE TARGET ACHIVEMENT',
                        exportOptions: {
                            format: {
            ...
            $('#Table2').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'ZONE WISE DISTRIBUTOR SALE',
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
