...
@section('content')
  <h3 class="text-danger">Payment Outstanding</h3>
  ...
  <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
    <form action="{{ url('salesandtargetpayout') }}" method="get" id="searchForm">
      ...
      <table id="Table1" class="table table-bordered table-striped table-hover w-100">
        <thead>
          <tr>
            ...
            <?php endif; ?>
            <th colspan="5" class="align text-white bg-danger text-center">Personwise Payment Outstanding UPTO -
              {{ $mon_yr }}</th>
    ...
    $(document).ready(function () {
      $('#Table1').DataTable({
        ...
        buttons: [
          {
            extend: 'excelHtml5',
            filename: 'Personwise Payment Outstanding',
            exportOptions: {
              format: {
