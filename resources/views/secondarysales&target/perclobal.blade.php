...
@section('content')
  <h3 class="text-danger">Person Wise Closing Balance</h3>
  ...
  <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
    <form action="{{ url('salesandtargetperclobal') }}" method="get" id="searchForm">
      ...
      <table id="Table1" class="table table-bordered table-striped table-hover w-100">
        <thead>
          <tr>
            ...
            <?php endif; ?>
            <th colspan="3" class="align text-white bg-danger text-center">Person Wise Closing Stock Value UPTO -
              {{ $mon_yr }}</th>
