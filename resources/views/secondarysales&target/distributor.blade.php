...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('salesandtargetdistributor') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="5" class="align text-white bg-danger text-center">STATE WISE DISTRIBUTOR SALE UPTO -
                            {{ $mon_yr }}
                        </th>
        ...
        ?>
                ...
                <tfoot class="table-danger">
                    <tr class="sticky-foot fw-bold">
                        ...
                        <?php if ($divisionTotals['totalPrimaryDis_cur_fy'] != 0) { ?>
