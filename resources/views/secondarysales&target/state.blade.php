...
@section('content')
    <h3 class="text-danger">Region And State Wise</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('salesandtargetstate') }}" method="get" id="searchForm">
                    ...
                    <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <?php endif; ?>
                                <th colspan="7" class="align text-white bg-danger text-center">STATE WISE TARGET ACHIVEMENT
                                    UPTO - {{ $mon_yr }}</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="align bg-warning">Region</th>
                                <th class="align bg-warning">State</th>
                                <th class="align bg-warning"><span class="text-warning" style="font-size:6px;">Purchase
                                    </span><?php echo $pre_fy_year; ?></th>
                                <th class="align bg-warning"><span class="text-warning" style="font-size:6px;">Purchase
                                    </span><?php echo $cur_fy_year; ?></th>
        ...
        foreach ($regions as $Region => $data) {
                        ?>
                            <tr>
                                ...
                                <td class="sticky-col" style="text-a lign:center;"><?php        echo $data['state']; ?></td>
                    ...
                    <table id="Table2" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <th colspan="5" class="align text-white bg-danger text-center">STATE WISE DISTRIBUTOR SALE
                                    UPTO - {{ $mon_yr }}</th>
    ...
    foreach ($all_ind_sal_reg as $value) {
        $Zone = $value->state;
        $Region = $value->region;
    ...
    foreach ($zoneData as $Zone => $regions) {
        ...
        <div class="card shadow-lg rounded-4 border-0 p-4">
            <h5 class="chart_tittle">State Wise Growth and Achievement Chart upto - {!! $mon_yr !!}</h5>
            ...
            $(document).ready(function () {
                $('#Table1').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'excelHtml5',
                            filename: 'STATE WISE TARGET ACHIVEMENT',
                            exportOptions: {
                                format: {
                ...
                $('#Table2').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'excelHtml5',
                            filename: 'STATE  WISE DISTRIBUTOR SALE',
                            exportOptions: {
                                format: {
                                    header: function (data, columnIdx) {
