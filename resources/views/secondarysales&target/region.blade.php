...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('salesandtargetregion') }}" method="get" id="searchForm">
                    ...
                    <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <?php endif; ?>
                                <th colspan="6" class="align text-white bg-danger text-center">REGION WISE TARGET ACHIVEMENT
                                    UPTO - {{ $mon_yr }}</th>
                    ...
                    <table id="Table2" class="table table-bordered table-striped table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="align text-white bg-danger text-center">{{ request('region') }}</th>
                                <?php endif; ?>
                                <th colspan="4" class="align text-white bg-danger text-center">REGION WISE DISTRIBUTOR SALE
                                    UPTO - {{ $mon_yr }}</th>

                            </tr>

                            <tr>
                                <th class="align text-white bg-secondary text-center">Region(D/S)</th>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <h5 class="chart_tittle">Region Wise Growth and Achievement Chart upto - {!! $mon_yr !!}</h5>
        ...
        $(document).ready(function () {
            ...
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'REGION WISE TARGET ACHIVEMENT',
                        exportOptions: {
                            format: {
            ...
            $('#Table2').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'REGION WISE DISTRIBUTOR SALE',
                        exportOptions: {
                            format: {
                                header: function (data, columnIdx) {
