...
@section('content')
  <h3 class="text-danger"> Purchase Invoice Details Report (Batch Number)</h3>
          ...
          <thead>
            ...
            <tr class="table-success">
              ...
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">DC
                  Number</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">DC Date</span>
              </th>
  ...
  <script>
    $(document).ready(function () {
      ...
      var table = $('#ReportTbl').DataTable({
        ...
        orderCellsTop: true,
        ajax: {
          url: "{{ url('getpinvdataswithbnorpt') }}",
          type: "GET",
          data: function (d) {
