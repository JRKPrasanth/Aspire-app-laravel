...
@section('content')
<h3 class="text-danger">HQ Wise Payment Outstanding</h3>
...
<div class="card shadow-lg rounded-4 border-0 p-4">
    <div class="table-responsive" style="overflow-x: auto;">
        ...
        <thead>
            ...
            <?php endif; ?>
                <th colspan="3" class="align text-white bg-danger text-center">Personwise Payment Outstanding AS ON - {{ $mon_yr }}</th>
