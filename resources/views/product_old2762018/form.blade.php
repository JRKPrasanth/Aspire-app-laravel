...
<div class="card-body card-block">
	    ...
	    <div class="stdivold">
		  ...
		  <div class="col-md-4">
<?php //dd($group_name);
			  if($group_name == "FINISHED GOODS" || $group_name == "SEMI FINISHED GOODS") { ?>
			   	<div class="form-group row ftype ">
			...
			<span class="showspan"> <i class="fa fa-refresh jcr_product_type_id"></i></span>
			  	...
			  	<div class="form-group row rtype ">
			<label for="inputIsValid" class="form-control-label col-md-4"><span style="color: red;  ">*</span>Product Type </label>
			<div class="col-md-6">
			<input type="text" name='product_type_id' rows='5' class='form-control product_type_id ' data-show-subtext="true" value="" required>
...
<br>
	...
	// });
     ...
     /* raja code for concat product create*/
		$(document).on('change','.product_variant_id,.product_pack_id,.product_packtype_id,.bulk_product_pack_id,.product_type_id',function(){
		...
		<?php if($group_name == "RAW MATERIALS" || $group_name == "PACKING MATERIALS" ){ ?>
	        ...
	        $('.product_group_id').trigger('click');
				  ...
				  $(".rdiv,.product_pack").hide();
				  $('.linesdiv').css("display", "none");
				  $('.product_variant_id,.product_packtype_id,.bulk_product_pack_id,.bulk_sublocator_id').prop('required',false);
