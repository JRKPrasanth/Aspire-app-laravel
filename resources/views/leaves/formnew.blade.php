                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--   <div class="ms-2">
                                <i class="fa fa-refresh jcr_leave_type text-primary pointer"></i>
                            </div> -->
                            </div>
                        </div>
                        ...
                        <div class="permission row g-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="hidden" id="no_of_hrs" name="alloted_hrs" class="form-control no_of_hrs">
                            </div>
                        </div>
    ...
    if (['131', '130'].includes(leave_type)) {
      ...
      if (no_of_days > eligible_leave) {
        ...
        $(document).on('change', '.leave_type', function () {
            ...
            if (leave_type) {
                ...
                $.get(url, function (data) {
                    ...
                    if (balance <= 0 && ['131', '130', '132', '277'].includes(leave_type)) {
        ...
        $(document).on('click', '.save_form', function () {
            ...
            const url = "{{ URL::to('overallleavesave') }}";
            const form = $('#leave');
        ...
        $(document).on("change", ".start_date_time, .end_date_time", function () {
            ...
            if (!start || !end) {
                $('.no_of_hrs').val('');
                return; // Don't proceed until both times are selected
            }
