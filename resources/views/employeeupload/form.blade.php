...
@section('content')
<h3 class="text-danger">Employee Upload</h3>
...
<div class="card shadow-lg rounded-4 border-0">
  ...
  <tr class="table-info">
    ...
    <th class='freeze'><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Employee Number</span></th>
    ...
    <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">E-mail</span></th>
    <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Batch Status</span></th>
...
$(document).ready(function() {
    ...
    var table = $('#EmpTbl').DataTable({
      ...
      serverSide: true,
                        scrollX: true,
                  scrollY: "50vh",
      ajax: "{{ route('getEmployeeuploaddata') }}",
      columns: [
		 {
          data: 'hr_employee_id',
          name: 'actions',
...
$('#globalDeleteModal').modal('show'); 
	...
	$('#globalConfirmDeleteBtn').on('click', function () {
		if (deleteId) {
				$.ajax({
					url: "{{ url('employeeuploaddelete') }}/" + deleteId,
					type: "GET",
...
//              
		...
		var url="{{URL::to('getEmployeevalidate')}}";
