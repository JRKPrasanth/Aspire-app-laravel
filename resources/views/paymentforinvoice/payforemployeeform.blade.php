  ...
  @include('layouts.breadcrumb')
    ...
    <div class="col-md-4">
        ...
        <div class=" row mb-3">
            ...
            <div class="col-md-6">
                <div class="input-group form_date col-md-8" data-date=""
            ...
            <div class="col-md-2">
                ...
                <tbody class="clone_lines_body">
                    ...
                    <tr class="rcopy clone">
                        ...
                        <td>
                            <input type="text" name="bulk_payment_amount[]" class="form-control  bulk_payment_amount " value="{{$value->net_amt}}" required >
                        </td>
                        <td>
...
$('.payment_type_id').on('change', function () {
 ...
 /*Karthigaa Purpose For Save Function*/      
    ...
    var red_url = "{{url('paymentforemployee')}}"
