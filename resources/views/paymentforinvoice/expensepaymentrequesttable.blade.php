...
@section('content')
  <h3 class="text-danger">
    ...
    Expense - Payment Request Approval
    <?php } else { ?>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      var table = $('#AccTbl').DataTable({
        ...
        scrollY: "50vh",
        orderCellsTop: true,
        ajax: "getexpenseRequestforpaymentData?pagemethod=" + pagemethod,
        columns: [
          {
            data: 'expense_id',
            orderable: false,
    ...
    $(document).on('click', '.paymentrequested button', function () {
      ...
      var url = "{{ URL::to('getexpensepaymentreq') }}/" + selected.join(",") + "?status=" + status;
