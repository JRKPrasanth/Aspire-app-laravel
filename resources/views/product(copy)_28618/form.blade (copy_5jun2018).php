...
<div class="card-body card-block">
	...
	<div class="col-md-4">
		...
		<div class="form-group row">
			<label for="inputIsValid" class="form-control-label col-md-4"><span style="color: red; font-size:20px; ">*</span>Product Color </label>
			<div class="col-md-6">
		...
		<div class="form-group row">
			<label for="inputIsValid" class="form-control-label col-md-4"><span style="color: red; font-size:20px; ">*</span>Product Pack Type </label>
			<div class="col-md-6">
		...
		<div class="form-group row">
			<label for="inputIsValid" class="form-control-label col-md-4"><span style="color: red; font-size:20px; ">*</span>Product Pack </label>
			<div class="col-md-6">
	    ...
	    <div class="form-group row">
			...
			<textarea style=" width: 140px; height: 78px;" id="concatenated_product" name="concatenated_product" class="form-control concatenated_product">{{ $productdata['concatenated_product'] }}</textarea>
			</div>
			<div class="col-md-1">
			</div>
		</div>
	...
	<div class="col-md-4" >
        ...
        <div class="form-group row">
	 	...
	 	<div class="form-group row sublocate">
			<label for="inputIsValid" class="form-control-label col-md-4"><span style="color: red; font-size:20px; ">*</span>Locator Code</label>
			<div class="col-md-6">
    ...
    <div class="col-md-4">
     	...
     	<div class="form-group row serpre">
