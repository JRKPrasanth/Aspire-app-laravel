...
<body>
                        ...
                        <div class="main_div">
                            ...
                            <table>
                               ...
                               <tr>
                                   ...
                                   <th>Allocated Engineer  </th>       :<td> <?php  echo $pm_data[0]->first_name ; ?></td>
                                   <?php } else { ?>
                                   <th>Allocated Agency  </th>       :<td> <?php  echo $pm_data[0]->agency_name ; ?></td>
                                   <?php } ?>
   ...
   <a href="{{URL::to('pmmonthlycheckapproval')}}">Approve</a>
