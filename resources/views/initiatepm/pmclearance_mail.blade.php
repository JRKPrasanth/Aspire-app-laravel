                        ...
                        <div class="main_div">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th>Shift Timing  </th>   : <td><?php  echo $pm_data[0]->shift_timing ; ?> </td>
                                    
                               </tr>
                               <tr>
                                   <th>Postpone Date  </th>   : <td><?php  echo $pm_data[0]->postponed_date ; ?> </td>
                                   <th>Department Name  </th>   : <td><?php  echo $pm_data[0]->sub_department_name ; ?> </td>
                               </tr>
                                
                            </table>
                            
   <a href="{{URL::to('pmagencyallocation')}}">Allocate Agency / Engineer</a> &nbsp;&nbsp;
                            <a href="{{URL::to('initiatepm')}}">PM Initiate</a>
