...
@section('content')
<h3 class="text-danger">Machine Files</h3>
...
$(document).ready(function() {
    ...
    var table = $('#MacTbl').DataTable({
      ...
      columns: [
        ...
        { data: 'machine_code', name: 'w_machine_hdr_t.machine_code' },
        {
          data: 'machine_id',
          name: 'actions',
          orderable: false,
	 ...
	 $(".create").click(function()
{
  var url="{{ URL::to('machinefilescreate')}}";
    ...
    const url = "{{ url('machinefilescreate') }}/" + id;
   ...
   // delete function
	...
	$('#globalConfirmDeleteBtn').on('click', function () {
		if (deleteId) {
				$.ajax({
					url: "{{ url('machinefilesdelete') }}/" + deleteId,
					type: "GET",
