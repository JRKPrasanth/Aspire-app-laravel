...
@media  only screen and (min-width: 1500px) {
  ...
  .bulk_line_account1{width:300px !important;}
  .bulk_line_account2{width:200px !important;}
  .bulk_line_account3{width:120px !important;}
  .bulk_line_account4{width:380px !important;}
  .bulk_budget_amount{width:100px !important;}
}
  .bulk_line_no{ width:50px; }
  .bulk_line_account1{ width:280px;}
  .bulk_line_account2{width:180px;}
  .bulk_line_account3{width:110px;}
  .bulk_line_account4{width:380px;}
...
{{ csrf_field() }}
  ...
  <a role="button">
       Budgets
   </a><span class="ui_close_btn"><a class="collapse-close pull-right btn-danger" onclick='location.href="{{ url('budgets') }}"'></a></span> 
        </h4>
...
<div class="card">
            ...
            <div>
                    ...
                    <div class="form-group row">
                        <label for="inputIsValid" class="form-control-label col-md-5"><span style="color:red">*</span>Budget Name</label>
                        <div class="col-md-7">
                            <input class="form-control budget_hdr_id" id="budget_hdr_id" name="budget_hdr_id" size="16" type="hidden" value="{{ $row->budget_hdr_id }}" readonly>
                            <input type="text" id="budget_name" name="budget_name" class="form-control budget_name" value="{{ $row->budget_name }}" required />
                        </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-4">
                           <div class="form-group row">
                                <label for="inputIsValid" class="form-control-label col-md-5"><span style="color:red">*</span>Budget Year</label>
                                <div class="col-md-7">
                                    <select name='budget_year' rows='5' id='budget_year' class='select2 budget_year' required>
                                        {!! $budget_year !!}
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputIsValid" class="form-control-label col-md-5"><span style="color:red">*</span>Budget From Period</label>
                                <div class="col-md-7">
                                    <select name='budget_from_period_id' rows='5' id='budget_from_period_id' class='select2 budget_from_period_id' required>
                             ...
                             <div class="form-group row">
                                <label for="inputIsValid" class="form-control-label col-md-5"><span style="color:red">*</span>Budget To Period</label>
                                <div class="col-md-7">
                                   <select name='budget_to_period_id' rows='5' id='budget_to_period_id' class='select2 budget_to_period_id' required >
                                        {!! $budget_to_period_id !!}
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="input-group form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                            <input class="form-control datepicker budget_from_date" id="budget_from_date" name="budget_from_date" size="16" type="text" value="{{ $row->budget_from_date }}" readonly>
                                            <!-- <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span> -->
                                        </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="input-group form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                            <input class="form-control datepicker budget_to_date" id="budget_to_date" name="budget_to_date" size="16" type="text" value="{{ $row->budget_to_date }}" readonly>
                                            <!-- <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span> -->
                                        </div>
                            ...
                            <div class="col-md-4">
                               <div class="form-group row" >
                                    <label for="inputIsValid" class="form-control-label col-md-5"><span style="color:red">*</span>Budget Check Level</label>
                                    <div class="col-md-7">
                                        <select name='budget_check_level' rows='5' class='budget_check_level select2' required>
                                            <option value="">--Please Select--</option>
                                            <option <?php if($row->budget_check_level =="OBSOLUTE") { echo "selected"; } else { echo ""; } ?> value="OBSOLUTE">OBSOLUTE</option>
                                            <option <?php if($row->budget_check_level =="ADISORY") { echo "selected"; } else { echo ""; } ?> value="ADISORY">ADISORY</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                          ...
                          <div class="col-md-7">
                              <input type="text" id="actual_line_total" name="actual_line_total" class="form-control actual_line_total" value="{{ $row->actual_line_total }}" readonly />
                          </div>
                          <div class="col-md-2">
                          </div>
                      </div>
                          ...
                          <div class="col-md-7">
                              <input type="text" id="variance_total" name="variance_total" class="form-control variance_total" value="{{ $row->variance_total }}" readonly />
                          </div>
                          <div class="col-md-2">
                          </div>
                      </div>
                                <div class="form-group row" >
                                    ...
                                    <div class="col-md-7">
                                        <select name='active' rows='5' class='form-control active' >
                                            <option <?php if($row->active =="YES") { echo "selected"; } else { echo ""; } ?> value="YES">YES</option>
                ...
                <tbody class="pmt_lines_body">
                    ...
                    <tr class="rcopy clone">
                        ...
                        <td>
                            ...
                            <select name="bulk_line_account2[]" id="bulk_line_account2" class="select2 bulk_line_account2" >{!! $value->line_account2 !!}</select>
                        </td>
                        <td>
                            
                            <select name="bulk_line_account3[]" id="bulk_line_account3" class="select2 bulk_line_account3" >{!! $value->line_account3 !!}</select>
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text"  name="bulk_budget_amount[]" class="form-control  bulk_budget_amount"  required="required" value="{{ $value->budget_amount }}"> 
                        </td>
                        <td>
                        ...
                        <input type="hidden" class="bulk_overaccperiod" name="bulk_overaccperiod[]" value="{{ $value->overaccperiod }}">
                        <input type="hidden" class="bulk_overallmonthamt" name="bulk_overallmonthamt[]" value="{{ $value->overallmonthamt }}">
                       
                        <td>
                            <a class="remove remove0">
                                <i class="fa btn-xs fa-2x fa-minus-circle rem" aria-hidden="true"></i>
                            </a>
                            <input type="hidden" name="counter[]" style="display: none;">
                        </td>
                    </tr>
                    @endforeach
                    ...
                    <tr class="rcopy clone">
                       ...
                       <td>
                            <select name="bulk_line_account1[]" id="bulk_line_account1" class="select2 bulk_line_account1" required="required" >{!! $line_account1 !!}</select>
                        </td>
                        <td>
                            
                            <select name="bulk_line_account2[]" id="bulk_line_account2" class="select2 bulk_line_account2" >{!! $line_account2 !!}</select>
                        </td>
                        <td>
                            <select name="bulk_line_account3[]" id="bulk_line_account3" class="select2 bulk_line_account3">{!! $line_account3 !!}</select>
                        </td>
                        <td>
                            <select name="bulk_line_account4[]" id="bulk_line_account4" class="select2 bulk_line_account4">{!! $line_account4 !!}</select>
                        </td>
                        <td>
                            <input type="text"  name="bulk_budget_amount[]" class="form-control  bulk_budget_amount" required="required" value="" >
                        </td>
                        <td>
                         <button type="button" class="btn rupee budgetamt bulk_budgetamt"  data-value="" data-row="0" data-toggle="modal"  >
                          Split Amount </button>
                        </td>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="form-group text-center">
            <button type="button" class="btn applychanges saveform validate" value="APPLYCHANGES">Apply Changes</button>
...
$('.budget_status,.company_id,.parent_budget_id,.original_budget_id').css("pointer-events","none");
...
$('.company_id').val(company).change();
        ...
        changeclassfields();
//$('.budget_from_period_id,.budget_to_period_id').attr("disabled",true);
...
//                        $('.budget_from_period_id,.budget_to_period_id').attr("disabled",false);
