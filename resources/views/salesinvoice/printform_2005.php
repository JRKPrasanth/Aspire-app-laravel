...
$pdf->Line(169, 93, 169, 290, $style);
$pdf->Line(181, 93, 181, 290, $style);
...
$pdf->SetFont('','','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(10,2, $value['uom_code'] ,0,'C');
...
$total = $pdf->getNumPages();
    ...
    if($oldY < 175)
    {
    $pdf->Rect(12, 193, 196, 98,'DF', "",  array(255, 255, 255));
//$pdf->Line(12, 193, 208, 193, $style);
//$pdf->Line(12, 183, 208, 183, $style);
$pdf->SetXY(60,186);
$pdf->SetFont('','B','12');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(150,2, number_format( $ttt,'2','.',''),0,'L'); 


$pdf->Line(12, 205, 208, 205, $style);



$pdf->Line(12, 216, 208, 216, $style);
$pdf->Line(82, 205, 82, 250, $style);
$pdf->Line(102, 205, 102, 250, $style);
$pdf->Line(144, 205, 144, 250, $style);
$pdf->Line(184, 205, 184, 250, $style);
...
$pdf->Line(102, 211, 184, 211, $style);
...
$pdf->Line(122, 211, 122, 250, $style);
...
$pdf->Line(162, 211, 162, 250, $style);
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(50,2, number_format( $gsttotal,'2','.',''),0,'L');

$pdf->Line(13, 244, 208, 244, $style);
$pdf->Line(13, 250, 208, 250, $style);

$pdf->SetXY(13,250);
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(150,2, "Amount (in words) :",0,'L');

$pdf->SetXY(11,255);
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(150,2, convert_number_to_words(round($gsttotal)),0,'L');
