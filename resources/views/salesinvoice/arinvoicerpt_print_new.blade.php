...
//Page header
    public function Header() {
        ...
        $this->Image($image_file, 15 , 6, 48, 25, 'JPG', '', 'T', false, 250, '', false, false, 0, false, false, false);
        // Set font
...
$company_address=$address_l.",".$street_l.",".$city_l.",".$state_l.",".$country_l;
//  dd($company_address);

$pdf->SetXY(85,14);
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(104,2,$company_address,'0','C');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, ": ".$invoice_number_h,0,1,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, ": ".$invoice_date_h,0,1,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(104,0,": " .$invoice_date_h,0,1,'R');
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, $state_code  ,0,1,'L');
 
 
$pdf->Line(99, 113, 99 , 123);

$address_s=implode('',$ship_address_s);
$city_s=implode('',$city_s);
$state_s=implode('',$state_s);

$country_s=implode('',$country_s);
$pincode_s=implode('',$pincode_s);

$ship_address=$address_s.",".$city_s.",".$state_s.",".$country_s.",".$pincode_s;

$address_b=implode('',$bill_address_b);
$city_b=implode('',$city_b);
$state_b=implode('',$state_b);
$country_b=implode('',$country_b);
$pincode_b=implode('',$pincode_b);

$bill_address=$address_b.",".$city_b.",".$state_b.",".$country_b.",".$pincode_b;
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(60,0, ": ".$ship_address ,0,'R');
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(70,4, ": ".$bill_address  ,0,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
//$pdf->MultiCell(64,10,$address,0,'L');
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(104,2,"" .$state_b ,0,'L');
...
$pdf->Line(73, 123, 73 , $y);
$pdf->Line(87, 123, 87 , $y);
$pdf->Line(101, 123, 101 , $y);
$pdf->Line(115, 43, 115 , $y);     
$pdf->Line(130, 123, 130 , $y);
$pdf->Line(148, 123, 148 , $y);
$pdf->Line(170, 123, 170 , $y);
$pdf->Line(191, 123, 191, $y);
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Multicell(50,10,$value['gst_tax'],0,'L');
...
$pdf->SetTextColor('0','0','0');
//dd($value);
$pdf->Multicell(50,10,$value['hsn_code'],0,'L');  
...
$gsttot=208;foreach($gst as $gstvalue)
{
   ...
   // $gst_total=$total_amount*$gstvalue['gst']/100;
  //  $gst_1=$gstvalue['CGSTVAL']/2;
       // $gst_2=$gstvalue['SGST_VAL']/2;
...
$pdf->MultiCell(15,10, number_format($gst_2),0,'R');
    ...
    $pdf->SetXY(146,$gsttot+5);
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(15,10,"GST" .$gstvalue['gst']."%",0,'R');
    
    
    
$pdf->SetXY(190,$gsttot+5);
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
//$pdf->MultiCell(15,10, number_format($gstvalue['gst_val']/2,'2','.','') ,0,'R');
//$pdf->MultiCell(15,10, number_format($gst_total),0,'R');
...
//$pdf->Cell(0,0, number_format($gst_total) ,0,1,'L');    
...
$net_amount=$gst_total+$total_amount-$dis_amt;
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
//$pdf->Cell(0,0, (round($net_amount))  ,0,1,'L');



$pdf->SetXY(23,220);
$pdf->SetFont('','','10');
$pdf->MultiCell(80,8,convert_number_to_words(round($sub_tot)),0,'L');
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->cell(50,10,(round($sub_tot)),0,'L');  
...
$total_amount_after_tax=$sgat+$cgst;


    $hsny=150;
foreach($sgcgstt as $key=>$value)
{
    
$pdf->SetXY(146,$hsny+75);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
//$pdf->MultiCell(15,10,$value,0,'R');
...
$pdf->SetTextColor('0','0','0');
//$pdf->Cell(0,0, $total_tax ,0,1,'L');
$pdf->Cell(0,0, number_format($gsttotal) ,0,1,'L');    
...
$tot_amt_aft_tax=$total_amount_after_tax+$gsttotal+$sub_tot-$dis_amt;
...
$pdf->SetFont('','B','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, (round($tot_amt_aft_tax))  ,0,1,'L');
