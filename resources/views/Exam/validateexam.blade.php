...
<style type="text/css"> 
    ...
    <form id="exam_result" class="exam_result">
	{{ csrf_field() }}
	<?php 
	    $url = 'examlist/'.$values->schedule_exam_hdr_id;
                                                ...
                                                <tr>
                                                   <td><?php echo $key+1; ?></td>
													...
													<td class="anstd">
													    ...
													    <td>
													        <select name="status[{{$key}}]" id="status" onchange="mark('<?php echo $key;?>',this.value)" class="form-control" required>
                        ...
                        <div class="row save_btn">
                		    <div class="col-lg-12 col-md-12">
                			    <div class="form-group text-center buttons">
                				    <button type="button" class="btn save saveform" value ="SUBMITTED" >Save Result</button>
                				</div>
                		    </div>
                	    </div>
                    </div>
