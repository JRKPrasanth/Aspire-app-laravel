...
<script>
	$(document).ready(function()
		...
		$('#emi_amount,#total_emi,#total_amount,#till_paid_amount,#till_remaining_amount').prop('readonly',true);
                ...
                /** Amount input box number check Start **/  
                $(document).on('keypress', '.amount_to_pay', function(ev){
		         ...
		         /** Amount input box number check eND **/   


                 /** cLEAR input box  sTART **/
                ...
                /** cLEAR input box  eND **/
                 ...
                 /**Jqgrid Select and Delete  START **/
