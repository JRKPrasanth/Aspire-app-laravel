...
<div class="container">
  <div class="row">
    ...
    <div class="card">
       ...
       <?php         $path = asset('images/jrks.png');
$type = pathinfo($path, PATHINFO_EXTENSION);
$data = file_get_contents($path); 
$base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);?>
            <img src="{{ $base64 }}" class="img-fluid" style="width:60px;height:60px; vertical-align:middle;">
             </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                   <p><b>Delivery Date:</b> {!! $delivery_date !!}</p>
                                    ...
                                    <br>
                                    <p><b>PO Tax Total:</b> {!! $po_tax_total!!}</p>
                                    <br>
                                   <p><b>PO Grand Total:</b> {!! $po_grand_total!!}</p>
                                    <br>
                            ...
                            <tr>
                                <td>
                                   ...
                                   <p><b>Payment Term Name:</b> {!! $payment_term_name !!}</p><br>
                                   <p><b>Payment Method Name:</b> {!! $payment_method_name !!}</p><br>
                                ...
                                <td>
                                  <p><b>Frieght Carriers:</b> {!! $carrier_name !!}</p>
                                    ...
                                    <br>
                                     <p><b>Supplier Ref No:</b> {!! $supplier_reference_no !!}</p>
                                    <br>
...
<!--                                    <p><b>Freight Amount:</b> {!! $freight_amount !!}</p>
                                    <br>-->
...
<thead>
              ...
              <tbody> <?php //dd($vlinesdata); ?>
                ...
                <?php $date = strtotime($promised_date); 
                     $date = date('d-m-Y', $date);?>
                                   <td>{{ $date}}</td>
                                   <td>{{ $promised_alternate_date}}</td>
