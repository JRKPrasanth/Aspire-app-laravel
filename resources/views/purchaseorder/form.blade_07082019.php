...
@media only screen and (min-width: 1500px) {
    ...
    .bulk_part_no {width: 110px !important;}
     .bulk_line_sub_total {width: 100px !important;}
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            <label class="align_left">Created By:<span class='create_by span_color'></span></label></br>
             <label class="align_left">Round Off:<span class='round_off_span span_color' id="round_off_span">{{ $row->round_off }}</span>   </label>  
        </div>
       </div>
</div>
...
<?php } ?> </tbody>
                     ...
                     <table id="file_choosen" border="1" style="width:100%;"  >
                     <tbody id="fp">
...
<select type="text" name="amendment_status" id="amendment_status" class="form-control amendment_status" readonly>
	...
	<div class="form-group row" style="display:none;">
        <label for="inputIsValid" class="form-control-label col-md-4">Round_off</label>
        <div class="col-md-6">                                       
            <input type="text" name="round_off" id="round_off" value="{{ $row->round_off }}" class="form-control round_off" readonly>
        </div>
        <div class="col-md-2">
        </div>
    </div>
...
<a href="#" class="showColumn" data-toggle="modal" data-target="#myShowColumn">show/hide</a>
...
<tr class="rcopy clone" class="approve">
  ...
  <td class="column3"><i class="fa fa-search productsearch"></i></td>
  ...
  <td class="pdtdes_div">
    ...
    <?php if($ids=="3")  { ?>
	 ...
	 <td class="hsn column10">
            ...
            <td class="column13">
                <input type="text" name="bulk_line_sub_total[]" class="form-control input-sm bulk_line_sub_total " value="{{ $value->line_sub_total }}" required="required">
            </td>
            <td class="column14">
            ...
            <td class="column15"><input type="text" name="bulk_qoh_qty[]" class="form-control  bulk_qoh_qty" value="{{ $value->qoh_qty }}" readonly ></td>
...
<?php } if(count($linedata) < 1 ) {  ?>
    <tr class="rcopy clone">
        ...
        <td class="column1">
            <input type="text" name="bulk_line_no[]" class="form-control input-sm bulk_line_no column1" value="1" readonly="readonly">
        </td>
        <td class="pdtdiv ">
 ...
 <td class="hsn column10">
            <select name="bulk_hsn_code[]" id="bulk_hsn_code" class="select2 bulk_hsn_code" required>{!! $hsn_code !!}</select>
                ...
                <td class="column13">
                    <input type="text" name="bulk_line_sub_total[]" class="form-control input-sm bulk_line_sub_total" value="" required="required">
                </td>
                <td class="column14">
                    <input type="text" name="bulk_line_total[]" class="form-control input-sm bulk_line_total" value="" required="required">
                </td>
                <td class="column15"><input type="text" name="bulk_qoh_qty[]" class="form-control  bulk_qoh_qty" value="" readonly></td>
                <td class="prodate column16">
...
<div class="modal fade" id="myShowColumn" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Show or Hide Columns</h4>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-md-4">

                <div class="l-checkbox form-group row ">
                            <div class=" c-checkbox">
                   ...
                   <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                               <input type="checkbox" name="pdtdiv" >
                                <span class="check_mark"></span>
                   ...
                   <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                               <input type="checkbox" name="column6" >
                                <span class="check_mark"></span>
                                <label for="">₹ </label>
                            </div>
                   ...
                   <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                              <input type="checkbox" name="column8" >
                                <span class="check_mark"></span>
                    ...
                    <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="column10" >
                                <span class="check_mark"></span>
                     ...
                     <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="column12" >
                                <span class="check_mark"></span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="hidepart" >
                                <span class="check_mark"></span>
                                <label for="">Supplier Part No</label>
                            </div>
                            
                        </div>
                      <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="column4" >
                                <span class="check_mark"></span>
                 ...
                 <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="column5" >
                                <span class="check_mark"></span>
                                <label for="">Qty   </label>
                            </div>
                     ...
                     <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="column7" >
                                <span class="check_mark"></span>
                     ...
                     <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                            <input type="checkbox" name="column9" >
                                <span class="check_mark"></span>
                     ...
                     <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                           <input type="checkbox" name="column11" >
                                <span class="check_mark"></span>
              ...
              <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                           <input type="checkbox" name="column14" >
                                <span class="check_mark"></span>
              ...
              <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                         <input type="checkbox" name="column16" >
                                <span class="check_mark"></span>
                                <label for="">Promised Date </label>
                            </div>
                        ...
                        <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                         <input type="checkbox" name="column18" >
                                <span class="check_mark"></span>
                       ...
                       <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                        <input type="checkbox" name="column13" >
                                <span class="check_mark"></span>
                       ...
                       <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                        <input type="checkbox" name="column15" >
                                <span class="check_mark"></span>
                                <label for="">Qoh Qty</label>
                            </div>
                            
                        </div>
                        <div class="l-checkbox form-group row">
                            <div class=" c-checkbox">
                        <input type="checkbox" name="column17" >
                                <span class="check_mark"></span>
                                <label for="">Promised Alternative Date</label>
                            </div>
                        ...
                        if(product_id !='' && product_id != '-- Please Select --'){
                            ...
                            if(pdtcount <= 0){
                                  $.get(url,function(data){   
                                        ...
                                        if(hsnid!=''){
                                         var condition="gst_code_hdr_id in("+hsnid+")";
...
<?php } ?>
    ...
    function pricelistchange()
	{
        ...
        if(plid != null || plid != ''){
         ...
         //   var condition="classification_name='SAC'";   +'&parent='+condition
    $(".bulk_hsn_code"+index).jCombo("{{ URL::to('jcomboform?table=f_gst_code_hdr_t:gst_code_hdr_id:classification_code') }}&order_by=classification_code asc",
    {selected_value:''});
        }
	}  
...
$(document).on('keyup change','.bulk_qty,.bulk_unit_price,.bulk_tax_group_id,.bulk_discount_percentage,.bulk_product_id,.transport_charges, .unloading_charges, .insurance_charges, .packing_charges,.other_freight_amount',function(){
   ...
   // alert(subtot);
    ...
    $(".bulk_line_sub_total"+index).val(subtot);
	$(".bulk_line_total"+index).val(linetot);
		/* Code for set linetotal values into header level field*/
			...
			$('.bulk_tax_amount').each(function(){
                ...
                sumall = Number(charge) + Number(sum);
				      round_off =  parseFloat(sumall-Math.round(sumall)).toFixed(2);
			$('#po_tax_total').val(sumtax);
			$('#po_grand_total').val(sumall);
      $(".tax_total_span").html(sumtax);
      $(".grand_total_span").html(sumall);
	   $(".round_off_span").html(round_off);
...
$('.add_row').click(function(){
	...
	$('.bulk_promised_alternate_date'+index).val(altdateval);
      ...
      /*Add row click show Pricelist Based Product*/
         <?php if($row->po_type !="LABOUR"){ ?> 
         <?php if($row->productcheck!="1"){ ?>
            var ind=$(".clone").last('tr').index();
            $('.bulk_product_id'+ind).html('');
            $('.bulk_product_id'+ind).html("<?php echo $productid ?>");
            $('.bulk_uom_code_id'+ind).html("<?php echo $uomcodeid ?>");
            $('.bulk_part_no'+ind).html("<?php echo $partno ?>");
...
function removeclassfields(){
        ...
        removeClass('bulk_line_sub_total');
