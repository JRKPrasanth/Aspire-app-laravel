...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="row g-3 mb-2">
            <div class="col-12 col-md-3">
                <a href="primarybusinessmis" class="btn btn-success w-100 text-white">Zone Wise</a>
            </div>
            <div class="col-12 col-md-3">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('primarybusinessmis') }}" method="get" id="searchForm">
            <div class="row g-3">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="align text-white bg-secondary text-center">Trg Vs Ach % {{ $cur_fy_year }} </th>
                        ...
                        <th class="align text-white bg-success text-center">Growth over {{ $pre_fy_year }}</th>
                        <th class="align text-white bg-success text-center">Trg Vs Ach % {{ $cur_fy_year }} </th>
                        <th class="align text-white bg-warning text-center">Dr. Coverage</th>
                        <th class="align text-white bg-warning text-center">Dr. Call Avg </th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($zone_wise_mis as $value) { ?>
                    <tr>
                ...
                <tfoot class="table-danger">
                    <?php foreach ($zone_wise_mis_gt as $value) { ?>
