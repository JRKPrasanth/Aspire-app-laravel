...
@section('content')
<h3 class="text-danger">  Final Settlement</h3>
...
<script>
    ...
    var table = $('#fandfTbl').DataTable({
      processing: true,
      serverSide: true,
      ajax: "{{ route('getfinalsettlementData') }}",
      columns: [
...

        {
          ...
          render: function (data, type, row) {
              return `
                  <button target="_blank"  class="btn btn-sm btn-primary me-1 print-btn" data-id="${data}">
                      Print
                  </button>
                  `;
