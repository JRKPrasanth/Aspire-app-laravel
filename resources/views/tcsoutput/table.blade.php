...
@section('content')
    <h3 class="text-danger">TCS Report</h3>
    @include('layouts.breadcrumb')

    <div class="card shadow-lg rounded-4 border-0 p-4">
        <div class="card-body">
            <div class="col-md-12">
                <form action="{{ url('tcsoutput') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <th class="align text-white bg-danger text-center">Period</th>
                        <th class="align text-white bg-danger text-center">Month-Yr</th>
                        <th class="align text-white bg-danger text-center">Name of the Customer</th>
                        <th class="align text-white bg-danger text-center">PAN</th>
                        <th class="align text-white bg-danger text-center">Invoice Ref.No</th>
                        <th class="align text-white bg-danger text-center">Date of Collection</th>
                        <th class="align text-white bg-danger text-center">Paid Amount</th>
                        <th class="align text-white bg-danger text-center">TCS Amount</th>
                        <th class="align text-white bg-danger text-center">TCS %</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
