...
@section('content')
<h3 class="text-danger">Arrear PF Delimiter</h3>
@include('layouts.breadcrumb')


<div class="card shadow-lg rounded-4 border-0 mb-4">

<div class="card-header bg-primary text-white fw-bold">ARREAR PF DELIMITER</div>
  <div class="card-body">
    <div class="row g-4">
      <div class="col-md-6">
...
$(document).ready(function()
{
      ...
      $("#year,#month").change(function()
    {
        ...
        if (month != '' && year != '')
        {
            ...
            var url = "{{URL::to('arrearpfdelimeterreport')}}";
            $('.detail').html("");
