  ...
  <div class="card shadow-lg rounded-4 border-0">
    ...
    <div class="card-body">
      ...
      <div class="text-center">
        <button type="button" class="btn btn-primary text-white report_search">
        ...
        <table id="RptTbl" class="table table-striped table-bordered">
          <thead>
            ...
            <tr class="table-danger">
              ...
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">PAN No</span>
              </th>
              ...
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Date of
                  Birth</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Sex</span>
              </th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Date of
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#RptTbl').DataTable({
        ...
        scrollY: "50vh",
        ajax: {
          url: "{{ url('employeeactivereportgrid') }}",
          type: "GET",
          data: function (d) {
            d.month = $('#month').val();
            d.year = $('#year').val();
