...
@section('content')
    <h3 class="text-danger">Employee Expenses Upload</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0">
        ...
        <div class="card-body">
            <form method="post" action="" id="empexpupload" enctype="multipart/form-data">
                {{ @csrf_field() }}
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('uploads/Emp_exp_upload.csv') }}" class="btn btn-outline-primary w-100" download>
                ...
                <div class="row mb-3 mt-4">
                    <div class="col-md-6 d-flex gap-2">
                        ...
                        <a class="btn btn-primary lineloaded px-4 me-2">
                            <i class="fa fa-database me-1"></i> Line Load
                        </a>
                    </div>

                    <div class="col-md-6 d-flex gap-2">
                        <input name="files[]" type="file" id="files" class="btn btn-light" multiple="multiple" />
                        <a class="btn btn-secondary docsupload px-4 me-2">
                            <i class="fa fa-database me-1"></i> DocsUpload
                        </a>
                    </div>
    ...
    <div class="card shadow-lg rounded-4 border-0">
        <div class="container mt-4">
            <div class="table-responsive">
                <table id="ExpTbl" class="table table-bordered table-striped w-100">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#ExpTbl').DataTable({
                ...
                columns: [
                    ...
                    { data: 'batchstatus', name: 'batchstatus' },
                    { data: 'batchdate', name: 'batchdate' },
                    { data: 'EmployeeName', name: 'EmployeeName' },
                    { data: 'EmployeeNumber', name: 'EmployeeNumber' },
                    { data: 'Zone', name: 'Zone' },
                    { data: 'UserName', name: 'UserName' },
                    { data: 'Total', name: 'Total' },
                    { data: 'choosefile', name: 'choosefile' },
                    { data: 'batchcomments', name: 'batchcomments' },
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            if (status == "ERROR") {
                window.location.replace('empexpuploadedit/' + id);
            }
            else {
        ...
        $.ajax({
            ...
            type: "GET",
            data: {
                table: "f_empexpupload_t:batchname:batchname",
                parent: condition1,
                order_by: "batchname asc"
            },
        ...
        $('#myModal1').on('shown.bs.modal', function () {
            $('.index').click(function () {
                ...
                if (tmp2 != "") {
                    var temp = tmp1 + tmp2;
                    $('.batch_name').val(temp);
                    var form_data = new FormData(document.getElementById('empexpupload'));
                    var $btn = $(this);
                    $btn.prop('disabled', true);
                    $.ajax({
                        url: "{{URL::to('empexpuploaddata')}}",
                        data: form_data,
                        type: 'POST',
        ...
        $('.verifyed').click(function () {
            ...
            var url = "{{URL::to('getempexpvalidate')}}";
