...
@section('content')
    <h3 class="text-danger">Open Stock Upload</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0">
        ...
        <div class="card-body">
            <form method="post" action="" id="openstockupload" enctype="multipart/form-data">
                {{ @csrf_field() }}
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <div class="col-md-3">
                        <a  href="{{ url('uploads/OPENSTOCK TEMPLATE.csv') }}" class="btn btn-outline-primary w-100" download>
                ...
                <span class="text-danger fw-bold">Maximum 500 Rows are Allowed. Others will be Skipped.</span>
                <!-- Action Buttons -->
    ...
    <div class="card shadow-lg rounded-4 border-0">
        <div class="container mt-4">
            <div class="table-responsive">
                <table id="StockTbl" class="table table-bordered table-striped w-100">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#StockTbl thead').on('keyup change', '.column-search', function () {
        ...
        $(document).on('click', '.edit-btn', function () {
            ...
            if (status == "ERROR") {
                window.location.replace('openstockedit/' + id);
            }
            else {
        ...
        $.ajax({
            ...
            type: "GET",
            data: {
                table: "i_product_openstock_upload_t:batch_name:batch_name",
                parent: condition1,
        ...
        $('#myModal1').on('shown.bs.modal', function () {
            $('.index').click(function () {
                ...
                if (tmp2 != "") {
                    var temp = tmp1 + tmp2;
                    $('.batch_name').val(temp);
                    var form_data = new FormData(document.getElementById('openstockupload'));
                    var $btn = $(this);            
                    $btn.prop('disabled', true);
                    $.ajax({
                        url: "{{URL::to('stockupload')}}",
                        data: form_data,
                        type: 'POST',
        ...
        $('.verifyed').click(function () {
            ...
            var url = "{{URL::to('getStockvalidate')}}";
