...
@section('content')
    ...
    <h3 class="text-danger">Production Overall Employee Detail Report</h3>
    ...
    <div class="container mt-4">
        <div class="row g-3 mb-3">
            ...
            <div class="col-12 col-md-3">
                <a href="overallprodctionperformancereport" class="btn btn-primary w-100">Overall Employee Report</a>
            </div>
            <div class="col-12 col-md-3">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <form action="{{ url('overallprodctionperformancereport') }}" method="get" id="searchForm">
            <div class="row g-4">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <div class="col-md-12">
            <h5 class="text-danger text-center">Overall Employee Machine Wise Work Hours Report - <b
                    class="text-primary">{{ $machine[0]->machine_name }}</b></h5>
        </div>
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                ...
                return $value->job_assigned_name == $category;
                    ...
                    <tr>
                        ...
                        <td style="text-decoration: underline;cursor: pointer;" class="sticky-col MachineEmp">
                            <b><?= $category ?></b></td>
    ...
    <script>
        ...
        $('.viewEmployee').click(function () {
            ...
            if (employeeName) {
                ...
                var url = "{{ route('productionemployewrk') }}" + "?" + params;
        ...
        $(document).ready(function () {
            $('.MachineEmp').click(function () {
                ...
                if (employee) {
                    ...
                    // AJAX request to fetch data
                    $.get("{{ route('productionemployemachinewrk', ['employee' => '']) }}/" + encodeURIComponent(employee) + "?start_date=" + startDate + "&end_date=" + endDate + "&machine=" + machineName, function (data) {
                        // Update HTML content with received data
