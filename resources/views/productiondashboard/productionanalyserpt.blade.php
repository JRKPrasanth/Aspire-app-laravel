...
@section('content')
    ...
    <h3 class="text-danger">Production Analyse Report</h3>

    <div class="container mt-4">
        <div class="row g-3 mb-3">
            <div class="col-12 col-md-3">
                <a href="productiondashboard" class="btn btn-success w-100">Analyse Report</a>
            </div>
            <div class="col-12 col-md-3">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <form action="{{ url('productiondashboard') }}" method="get" id="searchForm">
            <div class="row g-3">

                <div class="col-md-4">
                    <label for="pro_varient" class="form-label">Product Variant</label>
                    <select name='pro_varient[]' id='pro_varient' class='form-select select2' multiple>
                        {!! $pro_varient !!}
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name='pro_type' id='pro_type' class='form-select select2'>
                        {!! $pro_type !!}
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name='pro_name' id='pro_name' class='form-select select2'>
                        {!! $pro_name !!}
                    </select>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var Pro_cat = "{{ request('pro_subcat') }}";
            ...
            $('.pro_subcat').select2();
            $('#pro_subcat').val(Pro_cat).trigger('change');
        ...
        $(document).ready(function () {
            $('.prd_type').click(function () {
                ...
                if (prd_type) {
                    ...
                    var url = "{{ route('productionanalyspopup') }}" + "?" + params;
