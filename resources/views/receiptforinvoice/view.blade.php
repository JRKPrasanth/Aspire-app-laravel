			...
			<form>
					...
					<div class="card">
					 <div class="card-header">
						 <h2> ADVANCE PAYMENT FOR PO</h2>
						 <span class="ui_close_btn"><a href="../advancepayment" class="collapse-close pull-right btn-danger"></a></span>
					 </div>
        ...
        <div class="invoice-box" id="section-to-print">
            ...
            <table cellpadding="0" cellspacing="0">
                <tbody>
                    ...
                    <h2 class="heads1">ADVANCE PAYMENT FOR PO</h2>
