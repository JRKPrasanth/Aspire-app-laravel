...
@section('content')
<h3 class="text-danger mb-4">Profit And Loss Standard Report</h3>
        ...
        <form method="post" action="" id="job_card_reprot" class="needs-validation" novalidate
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="button" class="btn btn-success bg-gradient px-4 text-white report_search"
                        id="report_search">
...
<a href="{{URL::to('profitandlossregular.xls')}}" class='download_link' download></a>
...
<div class="container-fluid my-4">
    ...
    <div class="card shadow-lg rounded-4 border-0">
        ...
        <div class="card-header bg-danger text-white text-center">
            ...
            <div class="report text-primary report-title2"></div>

        </div>
        <div class="card-body">
            <button type="button" class="btn btn-info bg-gradient downloads">
...
<script>
    ...
    $('.report_search').click(function () {
        ...
        if (from_date != "") {
            ...
            var url_val = "{{URL::to('getprofitandlossstd')}}?start_date=" + from_date + "&end_date=" + to_date;
    ...
    $('.downloads').click(function () {
        ...
        if (from_date != "") {
            ...
            var url_val = "{{URL::to('getprofitandlossstd')}}?download=1&start_date=" + from_date + "&end_date=" + to_date;
            $.get(url_val, function (data) {
