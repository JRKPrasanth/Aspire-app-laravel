...
@section('content')
<h3 class="text-danger mb-4">Profit And Loss Report</h3>
        ...
        <form method="post" action="" id="job_card_reprot" class="needs-validation" novalidate
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="button" class="btn btn-primary bg-gradient px-4 text-white report_search"
                        id="report_search">
...
<div class="container-fluid my-4">
    ...
    <div class="card shadow-lg rounded-4 border-0">
        ...
        <div class="card-header bg-primary text-white text-center">
            ...
            <div class="report text-success fw-bold report-title2"></div>
...
<script>
    ...
    $('.report_search').click(function () {
        ...
        if (from_date != "") {
            ...
            var url_val = "{{URL::to('getprofitandloss')}}?start_date=" + from_date + "&end_date=" + to_date;
    ...
    $('.downloads').click(function () {
        ...
        if (from_date != "") {
            ...
            var url_val = "{{URL::to('getledgerpandlData')}}?download=1&start_date=" + from_date + "&end_date=" + to_date;
            $.get(url_val, function (data) {
