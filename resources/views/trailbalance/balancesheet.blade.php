...
@section('content')
<h3 class="text-danger mb-4">Balance Sheet Report</h3>
...
<div class="container-fluid my-4">
    ...
    <div class="card shadow-lg rounded-4 border-0">
        ...
        <div class="card-body">
            <button type="button" class="btn btn-primary bg-gradient downloads">
...
<script>
    ...
    $('.downloads').click(function () {
        ...
        if (from_date != "") {
            ...
            showCustomAlert("Please select Month","error");
        }
    });
