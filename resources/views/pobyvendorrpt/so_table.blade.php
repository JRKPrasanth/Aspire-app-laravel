...
<h5 class="heads">Sales Orders by Customer<h5>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                       <?php  
                          ...
                          <a class="btn-link supplier " data-value="{{$value->customer_id}}">{{ $value->customer_name }}</a> 
                          </td>
...
$(document).on('click','.supplier', function(ev){
		...
		var url="{{ URL::to('salesorderdetailsrpt')}}/?supplier_id="+supplier;
