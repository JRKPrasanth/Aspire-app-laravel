...
@section('content')
    <h3 class="text-danger">Area Wise</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('primarysalesandtargetarea') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="7" class="align text-white bg-danger text-center">AREA WISE SALES AND TARGET UPTO
                            {{ $mon_yr }}
                        </th>
                    ...
                    <tr>
                        ...
                        <th class="align  bg-warning text-center">Area</th>
                        <th class="align  bg-warning text-center"><span class="text-warning">Sale </span>{{ $pre_fy_year }}
                        </th>
                        <th class="align  bg-warning text-center"><span class="text-warning">Sale </span>{{ $cur_fy_year}}
                        </th>
                        <th class="align  bg-warning text-center"><span class="text-warning">Target </span>{{ $cur_fy_year}}
                        </th>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <h5 class="chart_tittle">Area Wise Growth And Achivement UPTO - {{ $mon_yr }}</h5>
        ...
        $(document).ready(function () {
            ...
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'primary_sale_and_target_area',
                        exportOptions: {
                            format: {
