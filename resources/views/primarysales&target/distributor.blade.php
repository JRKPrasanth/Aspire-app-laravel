...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('primarysalesdistributor') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="7" class="align  text-white bg-danger text-center">DISTRIBUTOR WISE SALES AND TARGET
                            UPTO {{ $mon_yr }}</th>
                    ...
                    <tr>
                        ...
                        <th class="align   bg-warning text-center">Distributor Names</th>
                        <th class="align   bg-warning text-center">{{ $pre_fy_year }}
                        </th>
                        <th class="align   bg-warning text-center">{{ $cur_fy_year}}
                        </th>
                        <th class="align   bg-warning text-center">{{ $cur_fy_year}}
                        </th>
    ...
    <!-- machine wise summary chart 
                 <div class='col-md-12 dash_charrt' >
        ...
        $(document).ready(function () {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'primary_sale_and_target_distributor',
                        exportOptions: {
                            format: {
