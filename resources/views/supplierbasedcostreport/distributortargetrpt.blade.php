...
@section('content')
  ...
  <h3 class="text-danger mb-4">Distributor Target Detail Report</h3>
        ...
        <table id="ReportTbl" class="table table-striped table-bordered">
          <thead>
            ...
            <tr class="table-info">
              ...
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Target
                  Month</span></th>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#ReportTbl').DataTable({
        ...
        columns: [
          { class: 'freeze', data: "stockist_name" },
          { data: "month" },
          { data: "mon" },
          { data: "Year" },
          { data: "target_qty" },
