...
@section('content')
<h3 class="text-danger">Account Upload</h3>
    ...
    <div class="card-body">
        <form method="post" action="" id="pricelistupload" enctype="multipart/form-data">
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-3">
                    <a href="../uploads/ACCOUNT TEMPLATE.csv" class="btn btn-outline-primary w-100" download>
                ...
                <div class="col-md-4">
                	...
                	<span class="text-danger fw-semibold">Maximum 500 Files are Allowed.Others will be Skipped.</span>
            </div>
...
<div class="card shadow-lg rounded-4 border-0">
    <div class="container mt-4">
        <div class="table-responsive">
            <table id="AccupTbl" class="table table-bordered table-striped w-100">
                <thead>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#AccupTbl').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "getAccountuploadData",
                data: function (d) {
        ...
        $('#AccupTbl thead').on('keyup change', '.column-search', function () {
    ...
    $(document).on('click', '.view-btn', function () {
        ...
        var id = $(this).data('id');
            ...
            window.location.replace('openstockview/' + id);
    ...
    $.ajax({
        ...
        type: "GET",
        data: {
            table: "f_account_upload_t:batch_name:batch_name",
            parent: condition1,
    ...
    $('.verifyed').click(function () {
        ...
        var url = "{{URL::to('accountuploadvalidate')}}";
    ...
    $('.loaded').click(function () {
        ...
        var newUrl = refineUrl();//fetch new url
        var url = "{{URL::to('getaccountvalidate')}}";
