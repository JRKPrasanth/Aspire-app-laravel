...
<script src="<?php echo e(asset('js/jquery.jCombo.min.js')); ?>"></script>
...
>>>>>>> c3e2ca1c19cb5279fa3b1c50ce69441e66c5f336:resources/views/layouts/header1.blade.php

<link href="<?php echo e(asset('css/select2.min.css')); ?>" rel="stylesheet" />
<script src="<?php echo e(asset('js/select2.min.js')); ?>"></script>
<!------------------------ Clone row Js --------------------------->
<script src="<?php echo e(asset('js/reCopy.js')); ?>"></script>



<<<<<<< HEAD:storage/framework/views/56a190b5dbcd3b995da19084c053a0c9e43c31e7.php
<!-------------------- Drag menus ------------------->
<link href="<?php echo e(asset('js/bs-iconpicker/css/bootstrap-iconpicker.min.css')); ?>" rel="stylesheet">
<script src="<?php echo e(asset('js/jquery-menu-editor.js?v5')); ?>"></script>
<script src="<?php echo e(asset('js/bs-iconpicker/js/iconset/iconset-fontawesome-4.2.0.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/bs-iconpicker/js/bootstrap-iconpicker.js')); ?>"></script>
<!-------------------- running ticker --------------->
<script src="<?php echo e(asset('js/jquery.webticker.min.js')); ?>"></script>
