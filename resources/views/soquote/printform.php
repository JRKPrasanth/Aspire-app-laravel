...
$pdf->Cell(0,0, "State Name : ".$state_l,0,1,'');
...
$pdf->SetFont('','','8');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, "Ph No : ".$contact_no,0,1,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, $address_c ,0,'L');
$oldad = $pdf->getY();

$pdf->SetXY(13,$oldad);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, "PH : ".$contact_number_c ,0,'L');
/*if($invoice_type!="SAMPLE"){
$pdf->SetXY(13,$oldad+4);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, "GSTIN/UIN : ".$gst_number ,0,'L');
}*/
$pdf->SetXY(13,$oldad+8);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, "Country Name : ".$country_c ,0,'L');

$pdf->SetXY(109,22);
$pdf->SetFont('','','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, "Quote No ",0,'L');

$pdf->SetXY(109,25);
$pdf->SetFont('','B','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, $quote_no,0,'L');
/*if($invoice_type!="SAMPLE"){
$pdf->SetXY(135,22);
$pdf->SetFont('','','8');
$pdf->SetTextColor('0','0','0');
...
$pdf->SetFont('','B','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, $quote_date,0,'L');
...
$pdf->SetFont('','B','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(100,2, $country_c,0,'L');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(82,2, $value['productid'] ,0,'L');
$y2=$pdf->getY();
$pdf->SetXY(26,$y2);
$pdf->SetFont('','','7');
$pdf->SetTextColor('0','0','0');
...
$pdf->SetFont('','','8');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(15,2, $value['unitprice'] ,0,'R');
...
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(150,2, number_format( $cashamount,\Session::get('decimal'),'.',''),0,'R'); 
