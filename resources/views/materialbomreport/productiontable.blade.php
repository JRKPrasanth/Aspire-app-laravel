...
<h2 class="heads"> Production report</h2>
            <div class="row">
...
$(document).on('click', '.report_search', function () {
       ...
       var to_date = $('#to_date').val();
          ...
          if(to_date=="")
             to_date=0;
         if(from_date!=0){
            var url = "{{URL::to('productionreportdetails')}}?from_date="+from_date+"&to_date="+to_date;
 ...
 console.log(url);
    ...
    { dataIndx: "plan_qty", align: "right",minWidth:"20%",title: "Plan Qty", filter: { crules: [{condition: "begin" }] }},
            ...
            var obj = {
                ...
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "Production Report"+file_date+"-"+time+".xlsx" );
                        });
                    ...
                    },
                    {
                        ...
                        label: 'Print',
                        listener: function () {
                            var exportHtml = this.exportData({ title: 'PRODUCTION REPORT', format: 'htm', render: true }),
