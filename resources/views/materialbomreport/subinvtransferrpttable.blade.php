...
@section('content')
  ...
  <h3 class="text-danger"> Subinventory Transfer Report </h3>
        ...
        <table id="ReportTbl" class="table table-striped table-bordered">
          <thead>
            <tr class="table-warning">
              <th class="freeze">Subinventory Transfer No</th>
              <th>Trx Date</th>
              <th>Receive Date</th>
            ...
            <tr class="table-danger">
              <th class="freeze"><input type="text" class="column-search" placeholder="Search"><span
                  style="display:none;">Subinventory Transfer No</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Trx
                  Date</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Receive
                  Date</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Manufacture
                  Date</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Expire
                  Date</span></th>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      var table = $('#ReportTbl').DataTable({
        ...
        orderCellsTop: true,
        ajax: {
          url: "{{ url('subinventorytransferreportdata') }}",
          type: "GET",
          data: function (d) {
        ...
        columns: [
          { class: "freeze", data: "subtransfer_no" },
          { data: "trx_date" },
          { data: "receive_date" },
          ...
          { data: "from_sublocator" },
          { data: "from_transfer_qty" },
