        ...
        <table id="ReportTbl" class="table table-striped table-bordered">
          <thead>
            <tr class="table-warning">
              <th class="freeze">Workorder No</th>
              <th>Workorde Date</th>
              <th>Plan No</th>
              <th>Start Date</th>
              <th>End Date</th>
            ...
            <tr class="table-info">
              <th class="freeze"><input type="text" class="column-search" placeholder="Search"><span
                  style="display:none;">Workorder No</span></th>
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Workorde
                  Date</span></th>
  ...
  <script>
    $(document).ready(function () {
      ...
      var table = $('#ReportTbl').DataTable({
        ...
        columns: [
          { class: 'freeze', data: "workorder_no" },
          { data: "workorder_date" },
          { data: "plan_no" },
          { data: "start_date" },
          { data: "end_date" },
