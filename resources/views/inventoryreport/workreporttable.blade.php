...
$( document ).ready(function() {
     var colModel=[
        ...
        { dataIndx: "sales_order_no",align: "center",title: "Product" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Batch No" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Work Activity" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Unit Pack" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Man Power" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum Of Act" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum Of Act Qty" , minWidth:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "sales_order_no",align: "center",title: "Sum Of In Days" ,minWidth:"15%", filter: { crules: [{condition: "begin" }] }}
        ];
  //define dataModel
        var dataModel = {
            location: "remote",            
