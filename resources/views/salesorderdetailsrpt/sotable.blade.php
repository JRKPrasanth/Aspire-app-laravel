...
<div class="panel-heading" role="tab" id="headingOne">
    ...
    <a role="button">Sales Order Details Report</a>
    </h4>
</div>
</div>
...
$('.view1').click(function(){
    ...
    var url_val="{{URL::to('SodetailsreportData') }}?from_date="+from_date+"&to_date="+to_date;
