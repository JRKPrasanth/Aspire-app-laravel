...
@section('content')
  <h3 class="text-danger">Region & State Wise Manpower</h3>
  ...
  <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
    <form action="{{ url('primarycostratiomanpowerstate') }}" method="get" id="searchForm">
      ...
      <table id="Table1" class="table table-bordered table-striped table-hover w-100">
        <thead>
          <tr>
            ...
            <th colspan="12" class="align text-white bg-danger text-center">ALL INDIA - REGION & STATE WISE MANPOWER -
              upto {{ $mon_yr}} </th>
          </tr>
  ...
  foreach ($sales_trend as $value) {
    ...
    $monthlySales[$value->f_year][$value->region][$value->state][$value->month] = $value->sale;
  }
  ...
  ?>
        ...
        <tfoot>
          <tr class="fw-bold table-danger">
            ...
            <td><?php  echo $grandTotal[$month]; ?></td>
            <?php endforeach; ?>
          </tr>
        </tfoot>
      </table>
    ...
    $(document).ready(function () {
      $('#Table1').DataTable({
        ...
        buttons: [
          {
            extend: 'excelHtml5',
            filename: 'cost_to_sale_STATE_WISE_MANPOWER',
          },
          {
            extend: 'pdfHtml5',
            filename: 'cost_to_sale_STATE_WISE_MANPOWER',
