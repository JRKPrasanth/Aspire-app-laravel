...
<div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
  <form action="{{ url('primarycostsaleratiozone') }}" method="get" id="searchForm">
        ...
        <thead>
            ...
            <?php elseif (request('division') != ''): ?>
                <?php endif; ?>
                    ...
                    <th colspan="3" class="align  text-white bg-danger text-center" >{{ $cur_fy_year }} upto {{ $mon_yr}}</th>
   ...
   <tbody>
    ...
    ?>
        <tr>
            ...
            <td >{{ $value->man }}</td>
               <?php if($value->sale  && $value->expence  !='0'){  ?><td >{{ number_format($value->expence / $value->sale * 100, 0) }}%</td> <?php }else{ ?><td >0</td> <?php } ?> 
   ...
   <tbody>
    ...
    ?>
        <tr>
            ...
            <td class="rupee-value" data-original="{{ $value->expence }}" >{{ $value->expence }}</td>
            <td >{{ $value->man }}</td>
               <?php if($value->sale !='0' && $value->expence  ){  ?><td >{{ number_format($value->expence / $value->sale * 100, 0) }}%</td> <?php }else{ ?><td >0</td> <?php } ?> 
