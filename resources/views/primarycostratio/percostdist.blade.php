...
@section('content')
    <h3 class="text-danger">Person Wise Cost</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('primarycostratiodist') }}" method="get" id="searchForm">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <th colspan="13" class="align text-white bg-danger text-center"> ALL INDIA - PERSON WISE COST
                            DISTRIBUTION - upto {{ $mon_yr}}</th>
                    </tr>
        ...
        $(document).ready(function () {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'cost_to_sale_PERSON_WISE_COST_DISTRIBUTION',
                    },
                    {
                        extend: 'pdfHtml5',
                        filename: 'cost_to_sale_PERSON_WISE_COST_DISTRIBUTION',
