...
@section('content')
    <h3 class="text-danger">Distributor Wise Sale Trend</h3>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('globalmisdistrend') }}" method="get" id="searchForm">
            <div class="row g-3">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="5" class="align text-white bg-danger text-center">PRODUCT WISE SALES AND GROWTH UPTO
                            {{ $mon_yr }}</th>
                    ...
                    <tr>
                        <th class="align text-white bg-success text-center">Division</th>
        ...
        $(document).ready(function () {
            ...
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'PRODUCT WISE SALES AND GROWTH',
                        exportOptions: {
                            format: {
