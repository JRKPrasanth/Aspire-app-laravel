...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('globalmisreport') }}" method="get" id="searchForm">
            <div class="row g-3">
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="4" class="align text-white bg-danger text-center">MONTH WISE SALES AND GROWTH UPTO
                            {{ $mon_yr }}</th>
                    ...
                    <tr>
                        <th class="align text-white bg-success text-center">Month</th>
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <h5 class="chart_tittle">Month Wise Growth UPTO - {{ $mon_yr }}</h5>
        ...
        $(document).ready(function () {
            ...
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'MONTH WISE SALES AND GROWTH',
                        exportOptions: {
                            format: {
