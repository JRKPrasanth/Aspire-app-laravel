...
@section('content')
            ...
            <table id="Table1" class="table table-bordered table-striped table-hover w-100">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th colspan="13" class="align text-white bg-danger text-center">DISTRIBUTOR WISE SALE TREND</th>
                    ...
                    <tr>
                        ...
                        <th class="align text-white bg-secondary text-center">Distributors name</th>
    ...
    foreach ($month_sample as $value) {
        ...
        $monthlySales[$value->f_year][$value->zone][$value->name][$value->month_y] = $value->sale;
    }
        ...
        $(document).ready(function () {
            ...
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'DISTRIBUTOR WISE SALE TREND',
                        exportOptions: {
                            format: {
