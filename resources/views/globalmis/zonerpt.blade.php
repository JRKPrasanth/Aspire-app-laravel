...
@section('content')
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4 mb-4">
        <form action="{{ url('globalmisreportzone') }}" method="get" id="searchForm">
            <div class="row g-3">
    ...
    <div class="card shadow-lg rounded-4 border-0 p-4">
        <h5 class="chart_tittle">Zone Wise Growth UPTO - {{ $mon_yr }}</h5>
        ...
        $(document).ready(function () {
            $('#Table1').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        filename: 'ZONE WISE SALES AND GROWTH',
                        exportOptions: {
                            format: {
