...
@section('content')
  <h3 class="text-danger">Packing Material Stock Ledger Report</h3>
        ...
        <table id="ReportTbl" class="table table-striped table-bordered">
          <thead>
            ...
            <tr class="table-info">
              ...
              <th><input type="text" class="column-search" placeholder="Search"><span style="display:none;">Category Name
              </th>
