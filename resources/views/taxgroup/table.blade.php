...
@push('scripts')
  ...
  <script>
...

          {
            ...
            render: function (data, type, row) {
              ...
              if (window.toolbarButtons?.some(btn => btn.attr.id === 'edit-btn')) {
                buttons += `
            <button class="btn btn-sm btn-primary edit-btn" data-id="${row.tax_group_id}">
              ...
              if (window.toolbarButtons?.some(btn => btn.attr.id === 'delete')) {
                buttons += `
            <button class="btn btn-sm btn-danger delete-btn" data-id="${row.tax_group_id}">
    ...
    $(".create").click(function () {
      var url = "{{ URL::to('taxgroupcreate')}}";
      window.location.replace(url);
    });
    //edit function
    $(document).on('click', '.edit-btn', function () {
      const id = $(this).data('id');
      const url = "{{ url('taxgroupcreate') }}/" + id;
    ...
    $('#globalConfirmDeleteBtn').on('click', function () {
      if (deleteId) {
        $.ajax({
          url: "{{ url('taxgroupdelete') }}/" + deleteId,
          type: "GET",
