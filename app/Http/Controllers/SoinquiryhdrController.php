...
use App\soinquiryhdr;
use App\soinquirylines;
use Illuminate\Http\Request;
use Illuminate\Database\Eloquent\Model;

class SoinquiryhdrController extends Controller
{
	public $module="soinquiryhdr";
    ...
    public function index()
	{
		...
		return view('soinquiryhdr.table',$this->data);
	}
	public function create($id=null)
	{
		...
		return view('soinquiryhdr.form',$this->data);
	}
	...
	public function edit(Request $request, $id)
	{
		...
		$this->data['project_id'] = $this->jCombo('projects_t','project_id','project_name',$table[0]->project_id);
		$this->data['product_id'] = $this->jCombo('products_final_t','product_id','concatenated_product','');
		$this->data['uomcode_id'] = $this->jCombo('m_uom_codes_t','uom_code_id','uom_code','');
 ...
 {
	 $soinq  = new soinquiryhdr();	 
	 $this->modelname = new Soinquiryhdr();
	...
	$soinq->remarks		     = $_POST['remarks'];
	 ...
	 /**************************** LineItems Save *****************************/
	 $id=$this->insertLines($this->modelline,$primary,$_POST,$_POST['so_inquiry_hdr_id']);
	...
	function insertLines($model_name,$primary,$data,$id)
	{
