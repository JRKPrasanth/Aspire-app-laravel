...
class ReceiptforinvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $this->data['sum_rec_tot'] = \DB::select("select * from (SELECT
     ROUND(SUM(s_invoice_hdr_t.invoice_grand_total),2) as sum_rec_total,
                        ROUND(SUM(s_invoice_hdr_t.balance_amount),2) as sum_bal_total
		...
		where 1=1  and s_invoice_hdr_t.balance_amount!=0 and s_invoice_hdr_t.invoice_status='APPROVED' ) as v1 where 1=1 $wh ");
    ...
    public function getSalesinvoicedetailsData()
    {
        ...
        if ($groupname == '1' || $groupname == 'Admin') {
            ...
            $wh1 .= " and ( ( s_invoice_hdr_t.invoice_date < '$grid_date'  and (s_invoice_hdr_t.balance_amount != 0 and s_invoice_hdr_t.invoice_status='APPROVED')) or  ( s_invoice_hdr_t.invoice_date BETWEEN '$grid_date' and '$gridenddate' ) )  ";
        ...
        if ($groupname == "14") {
            ...
            $wh1 .= " and s_invoice_hdr_t.ship_to_customer_id in (" . $cus_id[0]->dis . ")";
        }
    ...
    public function create($invid = null, $soid = null, $id = null)
    {
        ...
        /* purpose:get advance amount from so*/
    ...
    public function save(Request $request)
    {
        ...
        $form = $request->except([
            ...
            'submit_type',
            'choosefile',
            'existing_file','act_balance_amount','conversion_amt',
        ]);
        ...
        try {
            ...
            $total_amount = $_POST['advance_amount'] + $_POST['credit_amount'] - $_POST['debit_amount'];
