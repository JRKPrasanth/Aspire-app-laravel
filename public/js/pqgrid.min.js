...
function(t) {
    ...
    o._create = function() {
        ...
        this.iRenderB = new pq.cRenderBody(e, {
                ...
                e.onfocus(t)
            }).on("mousedown", e._onMouseDown(e)).on("change", e._onChange(e)).on("mouseenter", ".pq-grid-cell", e._onCellMouseEnter(e)).on("mouseenter", ".pq-grid-row", e._onRowMouseEnter(e)).on("mouseleave", ".pq-grid-cell", e._onCellMouseLeave(e)).on("mouseleave", ".pq-grid-row", e._onRowMouseLeave(e)).on("keyup", e._onKeyUp(e)), n.selectionModel["native"] || this.disableSelection(), y.bind("keydown.pq-grid", e._onKeyPressDown(e)), this._refreshTitle(), this.iRows = new i.cRows(this), this.generateLoading(), this._initPager(), this._refreshResizable(),
            this._refreshDraggable(), this.iResizeColumns = new i.cResizeColumns(this)
    }, o.addTouch = function() {
        var e, n, r;
        ...
        if ("height" === t) i(), this._refreshResizable();
            ...
            i();
            var d = l();
            this.element[d]("ui-corner-all"), this.$top[d]("ui-corner-top"), this.$bottom[d]("ui-corner-bottom")
        ...
        else if ("dataModel" == t) e.data !== s.data && s.dataUF && (s.dataUF.length = 0), i();
        else {
            ...
            if ("pageModel" == t) i();
                ...
                i();
                var c = this._toolbar.widget();
                c.css("display", e ? "" : "none")
            } else "collapsible" === t ? (i(), this._createCollapse()) : "showBottom" === t ? (i(), this.$bottom.css("display", e ? "" : "none")) : "rowBorders" === t ? (i(), d = l(), n = "pq-td-border-top", o.$tbl[d](n), a.$tbl[d](n)) : "columnBorders" === t ? (i(), d = l(), n = "pq-td-border-right", o.$tbl[d](n), a.$tbl[d](n)) : i()
        }
        return this
    }, o.options = {
        ...
        pageModel: {
            ...
            totalPages: 0,
            rPP: 10,
            rPPOptions: [10,50,100,250,500,1000]
        },
        resizable: !1,
        roundCorners: !0,
        rowBorders: !0,
    ...
    a.refreshCM = function(t, e) {
        ...
        r && (this.loading = !0, this.showLoading(), this.xhr = t.ajax({
            ...
            beforeSend: function(t, e) {
				...
				var pqs=n.element[0].id;
				$.cookie(pqs+'_pq_export_url',JSON.stringify(e.url));
        ...
        if (void 0 === w && "function" == typeof d.geditor && (w = d.geditor.call(x, m)),
            w !== !1) {
            ...
            if (m.cls = H, m.attr = O, "function" == typeof T && (M = T.call(x, m), M && (T = M)), C._type = T, "checkbox" == T) {
                var z = b.subtype,
                    U = v ? "checked='checked'" : "";
                M = "<input " + U + " class='" + F + "' " + O + " " + B + " type=checkbox name='" + g + "' />", D.html(M);
    ...
    n.getHeadCell = function(t) {
        ...
        onHeaderCellClick: function(e, n, r) {
            ...
            if (i._trigger("headerCellClick", r, {
                ...
                } else if (a.on && t(r.target).hasClass("pq-title-span")) {
...
function(t) {
    ...
    r.options = {
        ...
        var t = this,
            e = t.options;
        t.listeners = {}, t._queueATriggers = {}, t.iHistory = new n.cHistory(t), t.iGroup = new n.cGroup(t), t.iMerge = new n.cMerge(t), t.iFilterData = new n.cFilterData(t), t.iSelection = new o.Selection(t), t.iHeaderSearch = new n.cHeaderSearch(t), t.iUCData = new n.cUCData(t), t.iMouseSelection = new n.cMouseSelection(t), t._super(), new n.cFormula(t), t.iDragColumns = new n.cDragColumns(t), t.refreshToolbar(), "remote" === e.dataModel.location && t.refresh(), t.on("dataAvailable", function() {
            t.one("refreshDone", function() {
                t._trigger("ready"), setTimeout(function() {
                    t.element && t._trigger("complete")
                }, 0)
            })
        }), t.__init(), t.refreshDataAndView({
            header: !0
        })
    };
    var i;
    ...
    o.grid = function(e, n) {
        ...
        return i
    }, o.grid.render = {}, n.pqGrid.regional = {};
    var a = n.pqGrid.prototype;
    n.pqGrid.defaults = a.options, a.focus = function(e) {
    ...
    }, a._saveState = function(e, n, r) {
        var i, o, a, l;
        for (i in r) o = r[i], o && (a = e[i], t.isArray(o) ? null != a && (l = n[i] = {}, o.forEach(function(t) {
            l[t] = a[t]
        })) : n[i] = a)
        ...
        if (n._toolbar && (e = n._toolbar, e.destroy()), i) {
            ...
            e ? e.widget().replaceWith(c) : n.$top.append(c), e = o.toolbar(c, {
                items: d,
                gridInstance: n,
    ...
    }, a.getPlainOptions = function(e, n) {
        var r = e[0];
        ...
        return e
    }, a.getDataCascade = function(t, e, n) {
        var r, i, o = this,
    ...
    }, a.removeNullOptions = function(t, e, n) {
        var r;
    ...
    }, a._trigger = n._trigger, a.on = n.on, a.one = n.one, a.off = n.off, a.pager = function() {
        return this.pagerW
    }, a.toolbar = function() {
...
function(t) {
    ...
    n.convert = function(t, e) {
        ...
        getRulesFromCM: function(t) {
            var n = t.CM;
            if (!n) throw "CM N/A";
            for (var r = this, i = n.length, o = 0, a = t.location, l = [], s = e.cFilterData, d = function(t, e, n) {
                    return "remote" == a ? (t = null == t ? "" : t, t.toString()) : s.convertEx(t, e, n)
                }; i > o; o++) {
                var c = n[o],
                    u = c.filter;
                if (u) {
                    var h, f, p, g, v, m = c.dataIndx,
                        w = c.dataType,
                        x = u.crules || [u],
                        y = [],
                        w = w && "stringi" != w && "function" != typeof w ? w : "string";
                    x.forEach(function(t) {
                        p = t.condition, h = t.value, f = t.value2, p && r.isCorrect(p, h, f) && (v = r._getRulesFromCM(a, u, p, h, f, w, d)) && (h = v[0], f = v[1], g = v[2], y.push({
                            condition: v[3],
                            value: h,
                            value2: f,
                            cbFn: g
                        }))
                    }), y.length && ("remote" == a ? l.push({
                        dataIndx: m,
                        dataType: w,
                        value: y[0].value,
                        value2: y[0].value2,
            ...
            return (t.apply || "remote" == a) && this.sortRulesAndFMIndx(l), l
        },
    ...
    e.pqGrid.prototype.sort = function(t) {
        ...
        if (i && i.length || "local" != a) {
            ...
            if (t.sorter ? t.addon ? (t.single = h, t.cancel = f, l = d.addon(t)) : l = t.sorter : l = d.readSorter(), l.length || c.length) {
                ...
                d.resumeSort(), "local" == a && d.saveOrder(), d.setSorter(l), d.setSingle(h), d.writeSorter(l), d.writeSingle(h), "local" == a ? (r.data = d.sortLocalData(i, !0), this._queueATriggers.sort = {
                    evt: u,
                    ui: p
        ...
        compileSorter: function(t, e) {
            ...
            for (var g = 0; p > g; g++) {
                ...
                }(b, r.sort_dataType) : "date" == b ? l[g] = r["sort_date" + (I ? "_fast" : "")] : "bool" == b ? l[g] = r.sort_bool : "stringi" == b ? l[g] = r.sort_locale : l[g] = r.sort_string, I && n.useCache(e, b, m, _)
            }
...
function(t) {
    ...
    var i = r.cGroup = function(t) {
        ...
        e.model = "groupModel", e.cbId = n.cbId, e.childstr = "pq_children", e.prop = "pq_group_prop", e.that = t, n.on && e.init()
    };
    i.beforeTrigger = function(t, e) {
            ...
            return function u(h, f, p) {
                ...
                return b.forEach(function(t) {
                    ...
                    e = {
                        ...
                        parent: p,
                        pq_children: []
                    }, e[o ? a : m] = t[0], c.push(e), v && v.push(e), x && r(n, e, i), d > g + 1 ? u(n, g + 1, e) : c = l(c, n, e), i && c.push(i), C.push({
                        rip: h,
                        rip2: c.length
                    })
                }), c
        ...
        getRoots: function() {
            for (var t, e = this.that, n = e.pdata, r = n.length, i = 0, o = []; r > i; i++) t = n[i], 0 === t.pq_level && o.push(t);
            return o
        },
        getSumCols: function() {
        ...
        initmerge: function() {
            for (var t, e, n, r, i, o, a, l, s = this.that, d = s.options, c = d.groupModel, u = c.dataIndx, h = s.colIndxs, f = c.merge, p = c.summaryInTitleRow, g = c.titleInFirstCol, v = this.tree, m = s.riOffset, w = s.colModel.length, x = [], y = s.pdata, C = 0; C < v.length; C++) {
                t = v[C], n = h[u[C]];
                for (var b = 0, I = t.length; I > b && (e = t[b], r = e.rip, null != r); b++) f ? (i = e.rip2, o = i - r, a = r + m, x.push({
                    r1: a,
                    rc: o,
                    c1: n,
                    cc: 1
        ...
        onCustomSort: function(t, e) {
            var n = this.that,
                ...
                d = n.colIndxs[s],
                c = [];
            if (o.length && this.saveState(!1), "pq_order" != s) {
                if (i.titleInFirstCol && 0 === d) {
                    ...
                    return e.data = n.sort({
                        sorter: u,
                        data: e.data
                    }), !1
                }
                if (!r.pageModel.type && null != s && o.length && -1 === o.indexOf(s)) return (n.pageData() || []).forEach(function(t) {
                    t.pq_gtitle && t.pq_level === a && t.pq_children.sort(e.sort_composite).forEach(function(t) {
                        c.push(t)
                    })
                }), e.data = c.length ? c : e.data.sort(e.sort_composite), !1
            }
        },
        onDrop: function(t, e) {
            return function(n, r) {
        ...
        onDataReady: function(t, e) {
            return function() {
                ...
                var n = e.options.groupModel,
                    r = n.dataIndx.length;
                n.on && (r || n.grandSummary ? (t.groupData(), t.refreshColumns(), r && (t.initcollapsed(), t.initmerge(), t.isCascade(n) && t.cascadeInit())) : t.refreshColumns(), t.setValCBox()), t.createHeader()
            }
        },
...
function(t) {
    ...
    r.AnimH = function() {
        ...
        get$Col: function(t) {
            var e = this.grid;
            return e.iRenderB.get$Col(t).add(e.iRenderHead.get$Col(t)).add(e.iRenderSum.get$Col(t))
        },
        onBeforeCol: function(t) {
            if (!t.isDefaultPrevented() && !this.data) {
                ...
                i.forEach(function(t, e) {
                    t.pq_hideOld = t.hidden, t.pq_left = o.getLeft(e)
                }), o.eachH(function(t, r) {
                    e = n.get$Col(r), t.pq_render = 1, a.push([t, e.clone(), e.map(function(t, e) {
        ...
        oneRefreshCol: function() {
            if (this.data) {
                var t, e = this,
                    ...
                    r = n.iRenderB,
                    i = e.model.duration;
                r.eachH(function(n, o) {
                    delete n.pq_render;
                    var a = r.getLeft(o),
                        l = n.pq_left;
                    (l != a || n.pq_hideOld) && (t = e.get$Col(o), null == l ? t.css("opacity", 0).animate({
                        opacity: 1
                    }, i) : n.pq_hideOld ? t.css({
                        opacity: 0,
                        left: l
                    }).animate({
                        opacity: 1,
...
function(t) {
    ...
    e.prototype = {
        onCreate: function() {
            var e = this,
                n = e.that;
            t(e.drop ? document : n.$cont).on("mousedown", e.onMouseDown.bind(e))
        },
        ...
        onMouseMove: function(e) {
            (this.capture || t(document.elementFromPoint(e.pageX, e.pageY)).closest(this.that.$cont).length) && (this.capture = !0, this.process(e))
        },
        onMouseUp: function() {
    ...
    n.prototype = t.extend({}, pq.mixin.ChkGrpTree, pq.mixin.GrpTree, {
        ...
        onChange: function(t, e, n) {
            return function(r, i) {
                var o = i.source || "",
                    a = i.addList.length,
                    l = i.deleteList.length; - 1 == o.indexOf("checkbox") && ("undo" != o && "redo" != o || !a && !l ? n.summary && n.refreshOnChange && !a && !l ? (t.summary(), e.refresh()) : "addNodes" != o && "deleteNodes" != o || t.refreshViewFull() : t.refreshViewFull())
            }
        },
        ...
        onDataReadyAfter: function(t, e, n) {
            return function() {
                n.summary && t.summary(t), t.showHideRows(), t.isCascade(n) && t.cascadeInit()
            }
        },
        option: function(e, n) {
            var r, i = this,
        ...
        _summary: function(t, e, n, r, i, o) {
            for (var a, l, s, d, c, u = this, h = u.childstr, f = 0, p = t.length, g = 0, v = {}, m = {}, w = u.id, x = u.parentId, y = n.length, C = pq.aggregate; y > g; g++) c = n[g],
                v[c] = [];
            for (; p > f; f++)
        ...
        summary: function() {
            for (var t, e, n = this, r = n.that, i = n.getRoots(), o = [], a = [], l = [], s = [], d = 0, c = r.colModel, u = c.length; u > d; d++) t = c[d], e = t.summary, e && e.type && (l.push(t.dataIndx), s.push(t), a.push(e.type));
            n._summary(i, o, l, a, s), r.pdata = o
        },
        ...
        Export: function(t) {
		  ...
		  var e, n = this,
            ...
            if ("xlsx" == b) {
               ...
               return n.getexportexcel(t); 	
         
         
            }
         			
	},
        getexportexcel:function(t){
        var e, n = this,
                r = n.that,
                i = r.options,
                o = i.groupModel,
         ...
         var pqs=this.that.$cont.context.id;
		 ...
		 var I = n.getWorkbook(p, g, c, u, w, x, a, l, d, y, s, C, t.sheetName);
                ...
                return r._trigger("workbookReady", null, {
                    workbook: I
                }) === !1 ? I : t.workbook ? I : (t.workbook = I, pq.excel.exportWb(t))  
...
pqEx.colRatio = 8, pqEx.colWidth = 8.43 * pqEx.colRatio, pqEx.numFmtIds = function() {
    ...
    function(t) {
        ...
        }, t(document).on("pqGrid:bootup", function(t, i) {
            var o, a = i.instance,
                l = a.Group();
            for (o in r) n[o] = l[o], l[o] = r[o];
            l.primary = new e(a), a.on("beforeFilterDone", l.onBeforeFilterDone.bind(l)).one("CMInit", l.oneCMInit.bind(l))
        });
        var n = {},
            r = {
                ...
                transformData: function(t, e, n, r) {
                    ...
                    }), c.setDMData(p.data), p.data = d.pdata = s, v && this.addAggrInCM(w), w
                },
                addAggrInCM: function(t) {
                    var e, n = 0;
                    for (e in t) n++, this.addAggrInCM(t[e]);
                    n > 1 && (t.aggr = {})
                },
